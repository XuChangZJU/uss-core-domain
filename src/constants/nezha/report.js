...
const STATE_TRAN_MATRIX = {
    ...
    [action.startRepairing]: [[state.inRedoing, state.accepted, state.paused], state.inRepairing],
    [action.pauseRepairing]: [state.inRepairing, state.paused],
