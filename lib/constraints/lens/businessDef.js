...
var _require12 = require('../../constants/lens/trade'),
    ...
    TradeMainCategoryId = _require12.mainCategoryId;
...
var AppointmentBrandUserFn = function AppointmentBrandUserFn(states, hasPatientId, hasNotPatientId, needCheckIn) {
    var auth = {
        "#relation": {
...
var AUTH_MATRIX = {
    ...
    }), (0, _defineProperty3.default)(_workerOrder, WorkerOrderAction.reply, {
        auths: [{
            "#relation": {
                attr: 'trade.diagnosis.patient'
            },
    ...
    }), (0, _defineProperty3.default)(_workerOrder, WorkerOrderAction.finish, {
        auths: [{
            "#relation": {
                attr: 'trade.diagnosis.organization.brand',
                relations: [BrandRelation.owner, BrandRelation.manager, BrandRelation.customerService, BrandRelation.financialStuff]
            ...
            '#exists': [{
                ...
                condition: function condition(_ref57) {
                    ...
                    return {
                        ...
                        brandId: row.id,
                        relation: {
                            $in: [BrandRelation.owner, BrandRelation.manager, BrandRelation.customerService, BrandRelation.financialStuff]
                        }
                    };
                }
            }]
    ...
    patient: (_patient = {}, (0, _defineProperty3.default)(_patient, PatientAction.create, {
        auths: [{
            '#unexists': [{
                relation: 'patient',
                needData: true,
                ...
                condition: function condition(_ref58) {
                    ...
                    var patient = actionData.patient;
    ...
    }), (0, _defineProperty3.default)(_patient, PatientAction.sendMessage, {
        auths: [{
            '#exists': [{
                relation: 'userBrand',
    ...
    }), (0, _defineProperty3.default)(_patient, PatientAction.update, {
        auths: [{
            "#relation": {
                attr: ''
            }
    ...
    recheck: (_recheck = {}, (0, _defineProperty3.default)(_recheck, RecheckAction.create, {
        ...
        auths: [RecheckRootFn([RecheckState.inactive, RecheckState.active])]
    }), (0, _defineProperty3.default)(_recheck, RecheckAction.update, {
        auths: [{
            "#relation": {
                attr: 'trade.diagnosis.organization.brand'
            },
            '#data': function data(_ref70) {
                var actionData = _ref70.actionData,
                    row = _ref70.row;
            ...
            '#data': [{
                check: function check(_ref96) {
                    var user = _ref96.user,
                        row = _ref96.row,
                        actionData = _ref96.actionData;

                    if (actionData) {
                        var checkIn = actionData.checkIn;

                        var checkIn2 = omit(checkIn, ['remark', 'id']);
                        if ((0, _keys2.default)(checkIn2).length !== 0) {
    ...
    appointment: (_appointment = {}, (0, _defineProperty3.default)(_appointment, appointmentAction.create, {
        auths: [{
            '#exists': [{
                relation: 'schedule',
                message: '当日暂无排班',
    ...
    }), (0, _defineProperty3.default)(_appointment, appointmentAction.update, {
        auths: [{
            '#data': [{
                check: function check(_ref100) {
                    ...
                    if (actionData) {
                        ...
                        if ((0, _keys2.default)(appointment2).length !== 0) {
    ...
    }), (0, _defineProperty3.default)(_appointment, appointmentAction.remove, {
        auths: [AppointmentBrandUserFn([appointmentState.normal, appointmentState.cancelled], false, true, false)]
    ...
    }), (0, _defineProperty3.default)(_appointment, appointmentAction.checkEnd, {
        auths: [{
            "#role": [Roles.ROOT.name],
            '#data': [{
        ...
        auths: [AppointmentBrandUserFn([appointmentState.normal, appointmentState.late], true, false, true)]
        ...
        auths: [AppointmentBrandUserFn([appointmentState.normal, appointmentState.late], false, true, false)]
    }), _appointment),
    activity: (_activity = {}, (0, _defineProperty3.default)(_activity, activityAction.create, {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref119) {
                    var user = _ref119.user;
            ...
            '#data': [{
                check: function check(_ref120) {
                    var user = _ref120.user,
                        row = _ref120.row;
            ...
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref121) {
                    var user = _ref121.user,
                        row = _ref121.row;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref123) {
                    var user = _ref123.user;
            ...
            '#data': [{
                check: function check(_ref124) {
                    var user = _ref124.user,
                        row = _ref124.row;
            ...
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref125) {
            ...
            '#data': [{
                check: function check(_ref126) {
                    var user = _ref126.user,
                        row = _ref126.row;
    ...
    report: (_report = {}, (0, _defineProperty3.default)(_report, reportAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_report, reportAction.update, {
        auths: [{
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref127) {
    ...
    question: (_question = {}, (0, _defineProperty3.default)(_question, questionAction.create, {
        auths: [{
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref128) {
    ...
    revisit: (_revisit = {}, (0, _defineProperty3.default)(_revisit, revisitAction.create, {
        auths: [{
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref129) {
                    var user = _ref129.user;
        ...
        auths: [{
            ...
            '#data': [// 表示对现有对象或者用户的数据有要求，可以有多项，每项之间是AND的关系
            {
                check: function check(_ref130) {
                    var user = _ref130.user,
                        row = _ref130.row;
            ...
            '#data': [// 表示对现有对象或者用户的数据有要求，可以有多项，每项之间是AND的关系
            {
                check: function check(_ref131) {
                    var user = _ref131.user,
                        row = _ref131.row;
    ...
    revisitQuestion: (0, _defineProperty3.default)({}, revisitQuestionAction.update, {
        auths: [{
            ...
            '#exists': [{
                relation: 'revisit',
                condition: function condition(_ref132) {
                    var user = _ref132.user,
                        row = _ref132.row;
    ...
    signUp: (_signUp = {}, (0, _defineProperty3.default)(_signUp, signUpAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_signUp, signUpAction.update, AllowEveryoneAuth), (0, _defineProperty3.default)(_signUp, signUpAction.cancel, {
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref133) {
                    var user = _ref133.user,
                        row = _ref133.row;
            ...
            '#data': [{
                check: function check(_ref134) {
                    var user = _ref134.user,
                        row = _ref134.row;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref135) {
                    var user = _ref135.user,
                        row = _ref135.row;
            ...
            '#data': [{
                check: function check(_ref136) {
                    var user = _ref136.user,
                        row = _ref136.row;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref137) {
                    var user = _ref137.user,
                        row = _ref137.row;
    ...
    screening: (_screening = {}, (0, _defineProperty3.default)(_screening, screeningAction.create, {
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref138) {
                    var user = _ref138.user;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref139) {
                    var user = _ref139.user,
                        row = _ref139.row;
            ...
            '#data': [{
                check: function check(_ref140) {
                    var user = _ref140.user,
                        row = _ref140.row;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref141) {
                    var user = _ref141.user,
                        row = _ref141.row;
            ...
            '#data': [{
                check: function check(_ref142) {
                    var user = _ref142.user,
                        row = _ref142.row;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref143) {
                    var user = _ref143.user,
                        row = _ref143.row;
            ...
            '#data': [{
                check: function check(_ref144) {
                    var user = _ref144.user,
                        row = _ref144.row;
    ...
    }), (0, _defineProperty3.default)(_screening, screeningAction.finish, {
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref145) {
                    var user = _ref145.user,
                        row = _ref145.row;
            ...
            '#data': [{
                check: function check(_ref146) {
                    var user = _ref146.user,
                        row = _ref146.row;
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref147) {
                    var user = _ref147.user,
                        row = _ref147.row;
            ...
            '#data': [{
                check: function check(_ref148) {
                    var user = _ref148.user,
                        row = _ref148.row;
