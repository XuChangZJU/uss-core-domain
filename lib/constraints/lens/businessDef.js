...
var AUTH_MATRIX = {
        ...
        auths: [{
            '#exists': [{
                ...
                condition: function condition(_ref27) {
                    ...
                    var id = row.id;
                    var _actionData$worker = actionData.worker,
                        worker = _actionData$worker === undefined ? {} : _actionData$worker;
            ...
            '#exists': [{
                ...
                condition: function condition(_ref28) {
                    ...
                    var organizationId = row.organizationId,
                        jobId = row.jobId;
                    var _actionData$worker2 = actionData.worker,
                        worker = _actionData$worker2 === undefined ? {} : _actionData$worker2;
                    var number = worker.number;
        ...
        auths: [{
            '#exists': [{
                ...
                condition: function condition(_ref29) {
                    ...
                    if (jobId === Jobs.administrator) return {
                        userId: user.id,
                        worker: {
                            organizationId: organizationId,
                            jobId: {
    ...
    transmitter: (_transmitter = {}, _defineProperty(_transmitter, TransmitterAction.create, AllowEveryoneAuth), _defineProperty(_transmitter, TransmitterAction.bind, transmitterDeviceOrganizationWorker), _defineProperty(_transmitter, TransmitterAction.unbind, transmitterDeviceOrganizationWorker), _defineProperty(_transmitter, TransmitterAction.updateUuid, transmitterDeviceOrganizationWorker), _transmitter)
};
