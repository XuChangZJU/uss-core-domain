...
var _workerOrder, _brand, _patient, _diagnosis, _check, _record, _device, _organization, _worker, _transmitter;
 ...
 */
var _require = require('../../constants/lens/workerOrder'),
    WorkerOrderAction = _require.action;

var _require2 = require('../../constants/lens/brand'),
    BrandAction = _require2.action,
    BrandRelation = _require2.relation;

var _require3 = require('../../constants/lens/diagnosis'),
    DiagnosisAction = _require3.action,
    DiagnosisState = _require3.state,
    DIAGNOSIS_STATE_TRANS_MATRIX = _require3.STATE_TRANS_MATRIX,
    DiagnosisRelation = _require3.relation;

var _require4 = require('../../constants/lens/check'),
    CheckAction = _require4.action,
    CheckState = _require4.state,
    CHECK_STATE_TRANS_MATRIX = _require4.STATE_TRANS_MATRIX,
    CheckRelation = _require4.relation;

var _require5 = require('../../constants/lens/record'),
    RecordAction = _require5.action,
    RecordState = _require5.state,
    RecordRelation = _require5.relation;

var _require6 = require('../../constants/lens/patient'),
    PatientAction = _require6.action,
    PatientRelation = _require6.relation;

var _require7 = require('../../constants/lens/device'),
    DeviceAction = _require7.action,
    DeviceState = _require7.state,
    DEVICE_STATE_TRANS_MATRIX = _require7.STATE_TRANS_MATRIX;

var _require8 = require('../../constants/lens/organization'),
    OrganizationAction = _require8.action,
    OrganizationState = _require8.state,
    OrganizationRelation = _require8.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require8.STATE_TRANS_MATRIX;

var _require9 = require('../../constants/lens/worker'),
    WorkerAction = _require9.action,
    WorkerRelation = _require9.relation;
...
var AUTH_MATRIX = {
    ...
    }), _defineProperty(_check, CheckAction.remove, {
        auths: [{
            '#exists': [{
                relation: 'diagnosis',
