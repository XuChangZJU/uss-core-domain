...
var AUTH_MATRIX = {
    patient: (_patient = {}, _defineProperty(_patient, PatientAction.create, AllowEveryoneAuth), _defineProperty(_patient, PatientAction.update, OwnerRelationAuth), _defineProperty(_patient, PatientAction.remove, OwnerRelationAuth), _defineProperty(_patient, PatientAction.acquire, AllowEveryoneAuth), _patient),
    ...
    }), _defineProperty(_worker, WorkerAction.remove, workerOrganizationOwner), _defineProperty(_worker, WorkerAction.authGrant, workerOrganizationOwner), _defineProperty(_worker, WorkerAction.link, {
        auths: [{
            '#exists': [{
                relation: 'userWorker',
