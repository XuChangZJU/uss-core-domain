...
var _patient, _diagnosis, _check, _record, _device, _organization, _worker, _transmitter;
...
var _require2 = require('../../constants/lens/check'),
    CheckAction = _require2.action,
    CheckState = _require2.state,
    CHECK_STATE_TRANS_MATRIX = _require2.STATE_TRANS_MATRIX,
    CheckRelation = _require2.relation;
...
var _require5 = require('../../constants/lens/device'),
    DeviceAction = _require5.action,
    DeviceState = _require5.state,
    DEVICE_STATE_TRANS_MATRIX = _require5.STATE_TRANS_MATRIX;

var _require6 = require('../../constants/lens/organization'),
    OrganizationAction = _require6.action,
    OrganizationState = _require6.state,
    OrganizationRelation = _require6.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require6.STATE_TRANS_MATRIX;

var _require7 = require('../../constants/lens/worker'),
    WorkerAction = _require7.action,
    WorkerRelation = _require7.relation;

var _require8 = require('../../constants/lens/transmitter'),
    TransmitterAction = _require8.action,
    TransmitterState = _require8.state,
    TRANSMITTER_STATE_TRANS_MATRIX = _require8.STATE_TRANS_MATRIX,
    TransmitterType = _require8.type;

var _require9 = require('../action'),
...
var AUTH_MATRIX = {
    ...
    organization: (_organization = {}, _defineProperty(_organization, OrganizationAction.create, AllowEveryoneAuth), _defineProperty(_organization, OrganizationAction.bind, {
        auths: [{
            '#data': [{
