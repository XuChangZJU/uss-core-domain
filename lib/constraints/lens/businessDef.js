...
var AUTH_MATRIX = {
    patient: (_patient = {}, _defineProperty(_patient, PatientAction.create, AllowEveryoneAuth), _defineProperty(_patient, PatientAction.update, OwnerRelationAuth), _defineProperty(_patient, PatientAction.remove, OwnerRelationAuth), _defineProperty(_patient, PatientAction.link, AllowEveryoneAuth), _patient),
    ...
    organization: (_organization = {}, _defineProperty(_organization, OrganizationAction.create, AllowEveryoneAuth), _defineProperty(_organization, OrganizationAction.update, OrganizationOwner), _defineProperty(_organization, OrganizationAction.remove, OrganizationOwner), _defineProperty(_organization, OrganizationAction.enable, OrganizationOwner), _defineProperty(_organization, OrganizationAction.disable, OrganizationOwner), _organization),
    ...
    }), _defineProperty(_worker, WorkerAction.remove, workerOrganizationOwner), _defineProperty(_worker, WorkerAction.link, {
        auths: {
            '#exists': [{
                relation: 'userWorker',
