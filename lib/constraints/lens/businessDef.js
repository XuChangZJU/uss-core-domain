...
var _trade, _workerOrder, _brand, _patient, _diagnosis, _recheck, _record, _device, _organization, _transmitter, _clockIn, _schedule, _limits;
 ...
 */
var _require = require('../../constants/lens/clockIn'),
    ClockInAction = _require.action,
    ClockInCategory = _require.category;

var _require2 = require('../../constants/lens/schedule'),
    ScheduleAction = _require2.action;

var _require3 = require('../../constants/lens/limits'),
    LimitsAction = _require3.action,
    LimitsType = _require3.type;

var _require4 = require('../../constants/lens/trade'),
    TradeAction = _require4.action,
    TradeState = _require4.state,
    TradeGetMethod = _require4.getMethod,
    TRADE_STATE_TRAN_MATRIX = _require4.STATE_TRAN_MATRIX,
    TradeTransportState = _require4.transportState;

var _require5 = require('../../constants/lens/workerOrder'),
    WorkerOrderAction = _require5.action,
    WorkerOrderRelation = _require5.relation,
    WorkerOrderState = _require5.state,
    WORKERORDER_STATE_TRAN_MATRIX = _require5.STATE_TRAN_MATRIX;

var _require6 = require('../../constants/lens/brand'),
    BrandAction = _require6.action,
    BrandRelation = _require6.relation;

var _require7 = require('../../constants/lens/diagnosis'),
    DiagnosisAction = _require7.action,
    DiagnosisState = _require7.state,
    DIAGNOSIS_STATE_TRANS_MATRIX = _require7.STATE_TRANS_MATRIX,
    DiagnosisRelation = _require7.relation;

var _require8 = require('../../constants/lens/recheck'),
    RecheckAction = _require8.action,
    RecheckState = _require8.state,
    RECHECK_STATE_TRANS_MATRIX = _require8.STATE_TRANS_MATRIX;

var _require9 = require('../../constants/lens/record'),
    RecordAction = _require9.action,
    RecordState = _require9.state,
    RecordRelation = _require9.relation;

var _require10 = require('../../constants/lens/patient'),
    PatientAction = _require10.action,
    PatientRelation = _require10.relation;

var _require11 = require('../../constants/lens/device'),
    DeviceAction = _require11.action,
    DeviceState = _require11.state,
    DEVICE_STATE_TRANS_MATRIX = _require11.STATE_TRANS_MATRIX;

var _require12 = require('../../constants/lens/organization'),
    OrganizationAction = _require12.action,
    OrganizationState = _require12.state,
    OrganizationRelation = _require12.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require12.STATE_TRANS_MATRIX;
...
var _require13 = require('../../constants/lens/transmitter'),
    TransmitterAction = _require13.action,
    TransmitterState = _require13.state,
    TRANSMITTER_STATE_TRANS_MATRIX = _require13.STATE_TRANS_MATRIX,
    TransmitterType = _require13.type;

var _require14 = require('../action'),
    AllowEveryoneAuth = _require14.AllowEveryoneAuth,
    OwnerRelationAuth = _require14.OwnerRelationAuth,
    AnyRelationAuth = _require14.AnyRelationAuth;

var _require15 = require('../../constants/lens/roles'),
    Roles = _require15.Roles;
...
var AUTH_MATRIX = {
    ...
    diagnosis: (_diagnosis = {}, _defineProperty(_diagnosis, DiagnosisAction.create, /*[
                                                                                     ...
                                                                                     ]*/AllowEveryoneAuth), _defineProperty(_diagnosis, DiagnosisAction.update, AllowEveryoneAuth), _defineProperty(_diagnosis, DiagnosisAction.remove, {
        auths: [{
            "#relation": {
                attr: 'organization'
            }
        ...
        auths: [{
            '#exists': [{
                ...
                condition: function condition(_ref66) {
                    ...
                    var clockIn = actionData.clockIn;
                    var scheduleId = clockIn.scheduleId;
