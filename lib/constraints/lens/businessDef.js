...
var AUTH_MATRIX = {
    ...
    transmitter: (_transmitter = {}, _defineProperty(_transmitter, TransmitterAction.create, AllowEveryoneAuth), _defineProperty(_transmitter, TransmitterAction.bind, transmitterDeviceOrganizationWorker), _defineProperty(_transmitter, TransmitterAction.unbind, transmitterDeviceOrganizationWorker), _transmitter)
};
