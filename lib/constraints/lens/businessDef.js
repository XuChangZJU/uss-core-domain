...
var _qiniuFile, _trade, _workerOrder, _brand, _patient, _diagnosis, _recheck, _record, _device, _organization, _transmitter, _checkIn, _schedule, _limits, _appointment, _activity;
...
var _require = require('../../constants/lens/appointment'),
    appointmentAction = _require.action,
    APPOINTMENT_STATE_TRANS_MATRIX = _require.STATE_TRANS_MATRIX,
    appointmentState = _require.state,
    appointmentRelation = _require.relation;

var _require2 = require('../../constants/lens/activity'),
    activityAction = _require2.action,
    activityCategory = _require2.category,
    ACTIVITY_STATE_TRANS_MATRIX = _require2.STATE_TRANS_MATRIX,
    activityState = _require2.state;

var _require3 = require('../../constants/lens/qiniuFile'),
    qiniuFileAction = _require3.action,
    qiniuFileState = _require3.state;

var _require4 = require('../../constants/lens/checkIn'),
    CheckInAction = _require4.action,
    CheckInCategory = _require4.category;

var _require5 = require('../../constants/lens/schedule'),
    ScheduleAction = _require5.action;

var _require6 = require('../../constants/lens/limits'),
    LimitsAction = _require6.action,
    LimitsType = _require6.type;

var _require7 = require('../../constants/lens/trade'),
    TradeAction = _require7.action,
    TradeState = _require7.state,
    TradeGetMethod = _require7.getMethod,
    TRADE_STATE_TRAN_MATRIX = _require7.STATE_TRAN_MATRIX,
    TradeTransportState = _require7.transportState;

var _require8 = require('../../constants/lens/workerOrder'),
    WorkerOrderAction = _require8.action,
    WorkerOrderRelation = _require8.relation,
    WorkerOrderState = _require8.state,
    WORKERORDER_STATE_TRAN_MATRIX = _require8.STATE_TRAN_MATRIX;

var _require9 = require('../../constants/lens/brand'),
    BrandAction = _require9.action,
    BrandRelation = _require9.relation;

var _require10 = require('../../constants/lens/diagnosis'),
    DiagnosisAction = _require10.action,
    DiagnosisState = _require10.state,
    DIAGNOSIS_STATE_TRANS_MATRIX = _require10.STATE_TRANS_MATRIX,
    DiagnosisRelation = _require10.relation;

var _require11 = require('../../constants/lens/recheck'),
    RecheckAction = _require11.action,
    RecheckState = _require11.state,
    RECHECK_STATE_TRANS_MATRIX = _require11.STATE_TRANS_MATRIX;

var _require12 = require('../../constants/lens/record'),
    RecordAction = _require12.action,
    RecordState = _require12.state,
    RecordRelation = _require12.relation;

var _require13 = require('../../constants/lens/patient'),
    PatientAction = _require13.action,
    PatientRelation = _require13.relation;

var _require14 = require('../../constants/lens/device'),
    DeviceAction = _require14.action,
    DeviceState = _require14.state,
    DEVICE_STATE_TRANS_MATRIX = _require14.STATE_TRANS_MATRIX;

var _require15 = require('../../constants/lens/organization'),
    OrganizationAction = _require15.action,
    OrganizationState = _require15.state,
    OrganizationRelation = _require15.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require15.STATE_TRANS_MATRIX;
...
var _require16 = require('../../constants/lens/transmitter'),
    TransmitterAction = _require16.action,
    TransmitterState = _require16.state,
    TRANSMITTER_STATE_TRANS_MATRIX = _require16.STATE_TRANS_MATRIX,
    TransmitterType = _require16.type;

var _require17 = require('../action'),
    AllowEveryoneAuth = _require17.AllowEveryoneAuth,
    OwnerRelationAuth = _require17.OwnerRelationAuth,
    AnyRelationAuth = _require17.AnyRelationAuth;

var _require18 = require('../../constants/lens/roles'),
    Roles = _require18.Roles;
