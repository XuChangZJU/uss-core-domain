...
var AUTH_MATRIX = {
    ...
    recheck: (_recheck = {}, (0, _defineProperty3.default)(_recheck, RecheckAction.create, {
        ...
        auths: [{
            ...
            '#data': function data(_ref69) {
                var actionData = _ref69.actionData,
                    row = _ref69.row;
    ...
    revisitQuestion: (0, _defineProperty3.default)({}, revisitQuestionAction.update, {
        auths: [{
            ...
            '#exists': [{
                relation: 'revisit',
                condition: function condition(_ref130) {
