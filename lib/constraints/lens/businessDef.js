...
var AUTH_MATRIX = {
    patient: (_patient = {}, _defineProperty(_patient, PatientAction.update, PatientOwner), _defineProperty(_patient, PatientAction.remove, PatientOwner), _patient),
    ...
    }), _defineProperty(_diagnosis, DiagnosisAction.update, DiagnosisWorker), _defineProperty(_diagnosis, DiagnosisAction.complete, {
        auths: [{
            '#exists': [{
                relation: 'userWorker',
    ...
    device: (_device = {}, _defineProperty(_device, DeviceAction.enable, DeviceOrganizationWorker), _defineProperty(_device, DeviceAction.disable, DeviceOrganizationWorker), _device),
