...
var AUTH_MATRIX = {
    ...
    device: (_device = {}, _defineProperty(_device, DeviceAction.create, DeviceOrganizationWorker), _defineProperty(_device, DeviceAction.update, {
        auths: [{
            '#exists': [{
                relation: 'userWorker',
    ...
    }), _defineProperty(_worker, WorkerAction.authGrant, {
        auths: [{
            '#exists': [{
                relation: 'userWorker',
