...
var _qiniuFile, _trade, _workerOrder, _brand, _patient, _diagnosis, _recheck, _record, _device, _organization, _transmitter, _checkIn, _schedule, _limits, _appointment, _activity, _report, _question, _revisit, _singUp, _screening;
...
var AUTH_MATRIX = {
    ...
    singUp: (_singUp = {}, (0, _defineProperty3.default)(_singUp, signUpAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_singUp, signUpAction.update, AllowEveryoneAuth), (0, _defineProperty3.default)(_singUp, signUpAction.cancel, {
        auths: [{
            '#exists': [{
                relation: 'userRole',
    ...
    }), (0, _defineProperty3.default)(_singUp, signUpAction.regist, {
        auths: [{
            '#exists': [{
                relation: 'userRole',
    ...
    }), (0, _defineProperty3.default)(_singUp, signUpAction.allocWeChatQrCode, {
        auths: [{
            '#exists': [{
                relation: 'userRole',
