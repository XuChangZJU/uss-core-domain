...
var _require = require('../../constants/lens/revisit'),
    revisitAction = _require.action,
    REVISIT_STATE_TRANS_MATRIX = _require.STATE_TRANS_MATRIX;

var _require2 = require('../../constants/lens/question'),
    questionAction = _require2.action;

var _require3 = require('../../constants/lens/report'),
    reportAction = _require3.action;

var _require4 = require('../../constants/lens/appointment'),
    appointmentAction = _require4.action,
    APPOINTMENT_STATE_TRANS_MATRIX = _require4.STATE_TRANS_MATRIX,
    appointmentState = _require4.state,
    appointmentRelation = _require4.relation;

var _require5 = require('../../constants/lens/activity'),
    activityAction = _require5.action,
    activityCategory = _require5.category,
    ACTIVITY_STATE_TRANS_MATRIX = _require5.STATE_TRANS_MATRIX,
    activityState = _require5.state;

var _require6 = require('../../constants/lens/qiniuFile'),
    qiniuFileAction = _require6.action,
    qiniuFileState = _require6.state;

var _require7 = require('../../constants/lens/checkIn'),
    CheckInAction = _require7.action,
    CheckInCategory = _require7.category;

var _require8 = require('../../constants/lens/schedule'),
    ScheduleAction = _require8.action;

var _require9 = require('../../constants/lens/limits'),
    LimitsAction = _require9.action,
    LimitsType = _require9.type;

var _require10 = require('../../constants/lens/trade'),
    TradeAction = _require10.action,
    TradeState = _require10.state,
    TradeGetMethod = _require10.getMethod,
    TRADE_STATE_TRAN_MATRIX = _require10.STATE_TRAN_MATRIX,
    TradeTransportState = _require10.transportState;

var _require11 = require('../../constants/lens/workerOrder'),
    WorkerOrderAction = _require11.action,
    WorkerOrderRelation = _require11.relation,
    WorkerOrderState = _require11.state,
    WORKERORDER_STATE_TRAN_MATRIX = _require11.STATE_TRAN_MATRIX;

var _require12 = require('../../constants/lens/brand'),
    BrandAction = _require12.action,
    BrandRelation = _require12.relation;

var _require13 = require('../../constants/lens/diagnosis'),
    DiagnosisAction = _require13.action,
    DiagnosisState = _require13.state,
    DIAGNOSIS_STATE_TRANS_MATRIX = _require13.STATE_TRANS_MATRIX,
    DiagnosisRelation = _require13.relation;

var _require14 = require('../../constants/lens/recheck'),
    RecheckAction = _require14.action,
    RecheckState = _require14.state,
    RECHECK_STATE_TRANS_MATRIX = _require14.STATE_TRANS_MATRIX;

var _require15 = require('../../constants/lens/record'),
    RecordAction = _require15.action,
    RecordState = _require15.state,
    RecordRelation = _require15.relation;

var _require16 = require('../../constants/lens/patient'),
    PatientAction = _require16.action,
    PatientRelation = _require16.relation;

var _require17 = require('../../constants/lens/device'),
    DeviceAction = _require17.action,
    DeviceState = _require17.state,
    DEVICE_STATE_TRANS_MATRIX = _require17.STATE_TRANS_MATRIX;

var _require18 = require('../../constants/lens/organization'),
    OrganizationAction = _require18.action,
    OrganizationState = _require18.state,
    OrganizationRelation = _require18.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require18.STATE_TRANS_MATRIX;
...
var _require19 = require('../../constants/lens/transmitter'),
    TransmitterAction = _require19.action,
    TransmitterState = _require19.state,
    TRANSMITTER_STATE_TRANS_MATRIX = _require19.STATE_TRANS_MATRIX,
    TransmitterType = _require19.type;

var _require20 = require('../action'),
    AllowEveryoneAuth = _require20.AllowEveryoneAuth,
    OwnerRelationAuth = _require20.OwnerRelationAuth,
    AnyRelationAuth = _require20.AnyRelationAuth;

var _require21 = require('../../constants/lens/roles'),
    Roles = _require21.Roles;
