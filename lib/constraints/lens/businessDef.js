...
var AUTH_MATRIX = {
    ...
    }), _defineProperty(_record, RecordAction.remove, UnboundRecordDeviceOrganizationWorkerOrPatient), _record),
        ...
        // },
        {
            ...
            '#data': [{
                check: function check(_ref41) {
                    ...
                    return !deviceId && [TransmitterState.normal, TransmitterState.offline, TransmitterState.inactive].includes(row.state);
                }
            }]
        }]
