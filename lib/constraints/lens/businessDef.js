...
var AUTH_MATRIX = {
    ...
    activity: (_activity = {}, (0, _defineProperty3.default)(_activity, activityAction.create, {
        ...
        auths: [{
            ...
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref116) {
        ...
        auths: [{
            ...
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref120) {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref122) {
            ...
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref124) {
    ...
    report: (_report = {}, (0, _defineProperty3.default)(_report, reportAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_report, reportAction.update, {
        auths: [{
            '#exists': [{
                relation: 'userBrand',
                condition: function condition(_ref126) {
    ...
    revisitQuestion: (0, _defineProperty3.default)({}, revisitQuestionAction.update, {
        auths: [{
            ...
            '#exists': [{
                relation: 'revisit',
                condition: function condition(_ref131) {
    ...
    signUp: (_signUp = {}, (0, _defineProperty3.default)(_signUp, signUpAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_signUp, signUpAction.update, AllowEveryoneAuth), (0, _defineProperty3.default)(_signUp, signUpAction.cancel, {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref134) {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref136) {
    ...
    screening: (_screening = {}, (0, _defineProperty3.default)(_screening, screeningAction.create, {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref140) {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref142) {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref144) {
        ...
        auths: [{
            '#exists': [{
                relation: 'userRole',
                condition: function condition(_ref146) {
