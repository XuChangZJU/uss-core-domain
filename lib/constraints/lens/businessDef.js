...
var _qiniuFile, _trade, _workerOrder, _brand, _patient, _diagnosis, _recheck, _record, _device, _organization, _transmitter, _checkIn, _schedule, _limits, _appointment;
...
var _require2 = require('../../constants/lens/qiniuFile'),
    qiniuFileAction = _require2.action,
    qiniuFileState = _require2.state;

var _require3 = require('../../constants/lens/checkIn'),
    CheckInAction = _require3.action,
    CheckInCategory = _require3.category;

var _require4 = require('../../constants/lens/schedule'),
    ScheduleAction = _require4.action;

var _require5 = require('../../constants/lens/limits'),
    LimitsAction = _require5.action,
    LimitsType = _require5.type;

var _require6 = require('../../constants/lens/trade'),
    TradeAction = _require6.action,
    TradeState = _require6.state,
    TradeGetMethod = _require6.getMethod,
    TRADE_STATE_TRAN_MATRIX = _require6.STATE_TRAN_MATRIX,
    TradeTransportState = _require6.transportState;

var _require7 = require('../../constants/lens/workerOrder'),
    WorkerOrderAction = _require7.action,
    WorkerOrderRelation = _require7.relation,
    WorkerOrderState = _require7.state,
    WORKERORDER_STATE_TRAN_MATRIX = _require7.STATE_TRAN_MATRIX;

var _require8 = require('../../constants/lens/brand'),
    BrandAction = _require8.action,
    BrandRelation = _require8.relation;

var _require9 = require('../../constants/lens/diagnosis'),
    DiagnosisAction = _require9.action,
    DiagnosisState = _require9.state,
    DIAGNOSIS_STATE_TRANS_MATRIX = _require9.STATE_TRANS_MATRIX,
    DiagnosisRelation = _require9.relation;

var _require10 = require('../../constants/lens/recheck'),
    RecheckAction = _require10.action,
    RecheckState = _require10.state,
    RECHECK_STATE_TRANS_MATRIX = _require10.STATE_TRANS_MATRIX;

var _require11 = require('../../constants/lens/record'),
    RecordAction = _require11.action,
    RecordState = _require11.state,
    RecordRelation = _require11.relation;

var _require12 = require('../../constants/lens/patient'),
    PatientAction = _require12.action,
    PatientRelation = _require12.relation;

var _require13 = require('../../constants/lens/device'),
    DeviceAction = _require13.action,
    DeviceState = _require13.state,
    DEVICE_STATE_TRANS_MATRIX = _require13.STATE_TRANS_MATRIX;

var _require14 = require('../../constants/lens/organization'),
    OrganizationAction = _require14.action,
    OrganizationState = _require14.state,
    OrganizationRelation = _require14.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require14.STATE_TRANS_MATRIX;
...
var _require15 = require('../../constants/lens/transmitter'),
    TransmitterAction = _require15.action,
    TransmitterState = _require15.state,
    TRANSMITTER_STATE_TRANS_MATRIX = _require15.STATE_TRANS_MATRIX,
    TransmitterType = _require15.type;

var _require16 = require('../action'),
    AllowEveryoneAuth = _require16.AllowEveryoneAuth,
    OwnerRelationAuth = _require16.OwnerRelationAuth,
    AnyRelationAuth = _require16.AnyRelationAuth;

var _require17 = require('../../constants/lens/roles'),
    Roles = _require17.Roles;
...
var AUTH_MATRIX = {
    ...
    register: _defineProperty({}, appointmentAction.create, AllowEveryoneAuth)
};
