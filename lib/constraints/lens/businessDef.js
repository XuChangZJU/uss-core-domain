...
var AUTH_MATRIX = {
    ...
    organization: (_organization = {}, _defineProperty(_organization, OrganizationAction.create, AllowEveryoneAuth), _defineProperty(_organization, OrganizationAction.update, AllowEveryoneAuth), _defineProperty(_organization, OrganizationAction.remove, OrganizationOwner), _defineProperty(_organization, OrganizationAction.enable, OrganizationOwner), _defineProperty(_organization, OrganizationAction.disable, OrganizationOwner), _organization),
