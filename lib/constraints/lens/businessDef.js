...
var _qiniuFile, _trade, _workerOrder, _brand, _patient, _diagnosis, _recheck, _record, _device, _organization, _transmitter, _checkIn, _schedule, _limits, _appointment, _activity, _report;
...
var _require = require('../../constants/lens/report'),
    reportAction = _require.action;

var _require2 = require('../../constants/lens/appointment'),
    appointmentAction = _require2.action,
    APPOINTMENT_STATE_TRANS_MATRIX = _require2.STATE_TRANS_MATRIX,
    appointmentState = _require2.state,
    appointmentRelation = _require2.relation;

var _require3 = require('../../constants/lens/activity'),
    activityAction = _require3.action,
    activityCategory = _require3.category,
    ACTIVITY_STATE_TRANS_MATRIX = _require3.STATE_TRANS_MATRIX,
    activityState = _require3.state;

var _require4 = require('../../constants/lens/qiniuFile'),
    qiniuFileAction = _require4.action,
    qiniuFileState = _require4.state;

var _require5 = require('../../constants/lens/checkIn'),
    CheckInAction = _require5.action,
    CheckInCategory = _require5.category;

var _require6 = require('../../constants/lens/schedule'),
    ScheduleAction = _require6.action;

var _require7 = require('../../constants/lens/limits'),
    LimitsAction = _require7.action,
    LimitsType = _require7.type;

var _require8 = require('../../constants/lens/trade'),
    TradeAction = _require8.action,
    TradeState = _require8.state,
    TradeGetMethod = _require8.getMethod,
    TRADE_STATE_TRAN_MATRIX = _require8.STATE_TRAN_MATRIX,
    TradeTransportState = _require8.transportState;

var _require9 = require('../../constants/lens/workerOrder'),
    WorkerOrderAction = _require9.action,
    WorkerOrderRelation = _require9.relation,
    WorkerOrderState = _require9.state,
    WORKERORDER_STATE_TRAN_MATRIX = _require9.STATE_TRAN_MATRIX;

var _require10 = require('../../constants/lens/brand'),
    BrandAction = _require10.action,
    BrandRelation = _require10.relation;

var _require11 = require('../../constants/lens/diagnosis'),
    DiagnosisAction = _require11.action,
    DiagnosisState = _require11.state,
    DIAGNOSIS_STATE_TRANS_MATRIX = _require11.STATE_TRANS_MATRIX,
    DiagnosisRelation = _require11.relation;

var _require12 = require('../../constants/lens/recheck'),
    RecheckAction = _require12.action,
    RecheckState = _require12.state,
    RECHECK_STATE_TRANS_MATRIX = _require12.STATE_TRANS_MATRIX;

var _require13 = require('../../constants/lens/record'),
    RecordAction = _require13.action,
    RecordState = _require13.state,
    RecordRelation = _require13.relation;

var _require14 = require('../../constants/lens/patient'),
    PatientAction = _require14.action,
    PatientRelation = _require14.relation;

var _require15 = require('../../constants/lens/device'),
    DeviceAction = _require15.action,
    DeviceState = _require15.state,
    DEVICE_STATE_TRANS_MATRIX = _require15.STATE_TRANS_MATRIX;

var _require16 = require('../../constants/lens/organization'),
    OrganizationAction = _require16.action,
    OrganizationState = _require16.state,
    OrganizationRelation = _require16.relation,
    ORGANIZATION_STATE_TRANS_MATRIX = _require16.STATE_TRANS_MATRIX;
...
var _require17 = require('../../constants/lens/transmitter'),
    TransmitterAction = _require17.action,
    TransmitterState = _require17.state,
    TRANSMITTER_STATE_TRANS_MATRIX = _require17.STATE_TRANS_MATRIX,
    TransmitterType = _require17.type;

var _require18 = require('../action'),
    AllowEveryoneAuth = _require18.AllowEveryoneAuth,
    OwnerRelationAuth = _require18.OwnerRelationAuth,
    AnyRelationAuth = _require18.AnyRelationAuth;

var _require19 = require('../../constants/lens/roles'),
    Roles = _require19.Roles;
...
var AUTH_MATRIX = {
    ...
    trade: (_trade = {}, _defineProperty(_trade, TradeAction.completeCheck, {
        auths: [{
            '#relation': {
    ...
    appointment: (_appointment = {}, _defineProperty(_appointment, appointmentAction.create, AllowEveryoneAuth), _defineProperty(_appointment, appointmentAction.cancel, {
        auths: [{
        ...
        auths: [{
            '#exists': [{
                ...
                condition: function condition(_ref53) {
                    var actionData = _ref53.actionData,
                        user = _ref53.user;
