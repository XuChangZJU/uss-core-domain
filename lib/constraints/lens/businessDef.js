...
var _workerOrder, _brand, _patient, _diagnosis, _review, _record, _device, _organization, _worker, _transmitter;
...
var _require4 = require('../../constants/lens/review'),
    ReviewAction = _require4.action,
    ReviewState = _require4.state,
    REVIEW_STATE_TRANS_MATRIX = _require4.STATE_TRANS_MATRIX,
    ReviewRelation = _require4.relation;
...
var AUTH_MATRIX = {
    ...
    review: (_review = {}, _defineProperty(_review, ReviewAction.create, {
        auths: [{
            '#exists': [{
                relation: 'diagnosis',
                needData: true,
                condition: function condition(_ref18) {
                    var user = _ref18.user,
                        actionData = _ref18.actionData;
                    var review = actionData.review;
    ...
    }), _defineProperty(_review, ReviewAction.update, {
        auths: [{
            '#exists': [{
                relation: 'diagnosis',
    ...
    }), _defineProperty(_review, ReviewAction.complete, {
        auths: [{
            '#exists': [{
                relation: 'diagnosis',
    ...
    }), _defineProperty(_review, ReviewAction.remove, {
        auths: [{
            '#exists': [{
                relation: 'diagnosis',
