...
var _require2 = require('../../constants/lens/workerOrder'),
    ...
    WorkerOrderRelation = _require2.relation,
...
var AUTH_MATRIX = {
    ...
    brand: (_brand = {}, _defineProperty(_brand, BrandAction.update, OwnerRelationAuth), _defineProperty(_brand, BrandAction.transfer, OwnerRelationAuth), _defineProperty(_brand, BrandAction.authGrantMulti2, OwnerRelationAuth), _defineProperty(_brand, BrandAction.authRevoke, OwnerRelationAuth), _defineProperty(_brand, BrandAction.authAbandon, OwnerRelationAuth), _defineProperty(_brand, BrandAction.remove, OwnerRelationAuth), _brand),
    ...
    }), _defineProperty(_organization, OrganizationAction.authAbandon, {
        auths: [{
            "#relation": {}
        }, {
            "#relation": {
