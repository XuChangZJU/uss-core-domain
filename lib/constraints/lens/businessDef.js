...
var _workerOrder, _brand, _patient, _diagnosis, _recheck, _record, _device, _organization, _transmitter;
...
var _require4 = require('../../constants/lens/recheck'),
    RecheckAction = _require4.action,
    RecheckState = _require4.state,
    RECHECK_STATE_TRANS_MATRIX = _require4.STATE_TRANS_MATRIX,
    RecheckRelation = _require4.relation;
...
var AUTH_MATRIX = {
    ...
    }), _defineProperty(_organization, OrganizationAction.transfer, OwnerRelationAuth), _defineProperty(_organization, OrganizationAction.authGrantMulti2, OwnerRelationAuth), _defineProperty(_organization, OrganizationAction.bind, {
        auths: [{
            "#relation": {
                attr: 'brand'
            },
