...
var _company, _subscribedService, _session, _chatMessage, _repository, _label, _item, _extraInfo, _phoneCall;
...
var chatMessageUserSessionExists = {
    ...
    condition: function condition(_ref) {
        ...
        var chatMessage = actionData.chatMessage;
...
var AUTH_MATRIX = {
    ...
    }), (0, _defineProperty3.default)(_company, companyAction.remove, OwnerRelationAuth), (0, _defineProperty3.default)(_company, companyAction.enable, OwnerRelationAuth), (0, _defineProperty3.default)(_company, companyAction.disable, OwnerRelationAuth), (0, _defineProperty3.default)(_company, companyAction.authRevoke, {
        auths: [{
            '#relation': {
                relations: [companyRelation.owner, companyRelation.manager, companyRelation.service, companyRelation.technician, companyRelation.preSaleService, companyRelation.postSaleService]
            }
    ...
    extraInfo: (_extraInfo = {}, (0, _defineProperty3.default)(_extraInfo, commonAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_extraInfo, commonAction.update, AllowEveryoneAuth), (0, _defineProperty3.default)(_extraInfo, commonAction.remove, AllowEveryoneAuth), _extraInfo),
    phoneCall: (_phoneCall = {}, (0, _defineProperty3.default)(_phoneCall, commonAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_phoneCall, commonAction.update, AllowEveryoneAuth), (0, _defineProperty3.default)(_phoneCall, commonAction.remove, AllowEveryoneAuth), _phoneCall)
};
