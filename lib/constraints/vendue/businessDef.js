...
var _vendue, _session, _auction, _bid, _paddle, _auctionHouse, _collection, _contract, _stock, _checkOut, _license, _contractTerms;
...
var _require2 = require('../../constants/vendue/deposit'),
    depositAction = _require2.action,
    depositState = _require2.state,
    DEPOSIT_STATE_TRAN_MATRIX = _require2.STATE_TRAN_MATRIX;

var _require3 = require('../../constants/vendue/checkOut'),
    checkOutAction = _require3.action,
    checkOutState = _require3.state,
    CHECKOUT_STATE_TRAN_MATRIX = _require3.STATE_TRAN_MATRIX;

var _require4 = require('../../constants/vendue/cashIn'),
    cashInAction = _require4.action,
    cashInState = _require4.state,
    CASHIN_STATE_TRAN_MATRIX = _require4.STATE_TRAN_MATRIX;

var _require5 = require('../../constants/vendue/auctionHouse'),
    auctionHouseAction = _require5.action,
    auctionHouseState = _require5.state,
    AUCTIONHOUSE_STATE_TRAN_MATRIX = _require5.STATE_TRAN_MATRIX,
    auctionHouseRelation = _require5.relation;
...
var _require13 = require('../../constants/vendue/paddle'),
    ...
    isPaddleOnline = _require13.isPaddleOnline;

var _require14 = require('../../constants/vendue/license'),
    licenseAction = _require14.action,
    license_STATE_TRAN_MATRIX = _require14.STATE_TRAN_MATRIX;

var _require15 = require('../../constants/vendue/contractTerms'),
    contractTermsAction = _require15.action,
    contractTermsState = _require15.state,
    CONTRACTTERMS_STATE_TRAN_MATRIX = _require15.COMMON_STATE_TRAN_MATRIX;
...
var AUTH_MATRIX = {
    ...
    deposit: _defineProperty({}, depositAction.create, AllowEveryoneAuth),
    checkOut: (_checkOut = {}, _defineProperty(_checkOut, checkOutAction.create, AllowEveryoneAuth), _defineProperty(_checkOut, checkOutAction.makePaid, {
        auths: [{
            "#relation": {
                attr: 'paddle.vendue',
                relations: [vendueRelation.administrator]
    ...
    cashIn: _defineProperty({}, cashInAction.create, AllowEveryoneAuth),
