...
var _vendue, _session, _auction, _bid, _paddle, _auctionHouse, _collection, _contract, _stock, _deposit, _checkOut, _cashIn, _license, _agent, _qiniuFile, _paymentRecord, _banner;
...
var _require22 = require('../../constants/roleConstant2'),
...
var AuctionGeneralChangeStateControl = function AuctionGeneralChangeStateControl(state, msg) {
    return {
        auths: [{
            '#relation': {
                attr: 'session',
...
var BidGeneralUpdateControl = function BidGeneralUpdateControl(states) {
    return {
        auths: [{
            "#relation": {
...
var DepositExistsPaddleVendue = {
    ...
    condition: function condition(_ref13) {
        var actionData = _ref13.actionData;
...
var AUTH_MATRIX = {
    ...
    auction: (_auction = {}, (0, _defineProperty3.default)(_auction, auctionAction.create, AuctionCreateControl), (0, _defineProperty3.default)(_auction, auctionAction.update, AuctionCheckBidUnexistedControl), (0, _defineProperty3.default)(_auction, auctionAction.ready, AuctionGeneralChangeStateControl([auctionState.preparing], '非准备状态的展品不能就绪')), (0, _defineProperty3.default)(_auction, auctionAction.start, AuctionGeneralChangeStateControl([auctionState.ready, auctionState.unsold], '非就绪和未成交状态的展品不能进入拍卖')), (0, _defineProperty3.default)(_auction, auctionAction.sold, AuctionGeneralChangeStateControl([auctionState.ongoing], '非拍卖状态的展品不能成交')), (0, _defineProperty3.default)(_auction, auctionAction.unsold, AuctionGeneralChangeStateControl([auctionState.ongoing], '非拍卖状态的展品不能流拍')), (0, _defineProperty3.default)(_auction, auctionAction.remove, AuctionCheckBidUnexistedControl), (0, _defineProperty3.default)(_auction, auctionAction.assign, AllowEveryoneAuth), (0, _defineProperty3.default)(_auction, auctionAction.authRevoke, AllowEveryoneAuth), _auction),
        ...
        auths: [{
            ...
            '#exists': [{
                ...
                condition: function condition(_ref57) {
                    var actionData = _ref57.actionData;
                    var bid = actionData.bid;
            ...
            '#exists': [{
                ...
                condition: function condition(_ref58) {
                    var actionData = _ref58.actionData;
                    var bid = actionData.bid;
    ...
    }), (0, _defineProperty3.default)(_bid, bidAction.success, BidGeneralUpdateControl([bidState.bidding])), (0, _defineProperty3.default)(_bid, bidAction.remove, BidGeneralUpdateControl([bidState.bidding])), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success])), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success])), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed])), _bid),
    ...
    checkOut: (_checkOut = {}, (0, _defineProperty3.default)(_checkOut, checkOutAction.taPrepare, {
        auths: [CheckOutGuestCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.shipping]), CheckOutVendueWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.shipping]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.shipping])]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.taCancel, {
        auths: [CheckOutGuestCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.shipping]), CheckOutVendueWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.shipping]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.shipping])]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.taSend, {
        auths: [CheckOutVendueWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.tsInPreparing]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.tsInPreparing])]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.taAccept, {
        auths: [CheckOutGuestCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.tsSending])]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.takeAway, {
        auths: [CheckOutVendueWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.tsInPreparing, checkOutTransportState.shipping]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.taPrepare, null, [checkOutTransportState.tsInPreparing, checkOutTransportState.shipping])]
        ...
        auths: [CheckOutVendueWorkerCheckFn(checkOutAction.changePrice, [checkOutState.init, checkOutState.unpaid], null), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.changePrice, [checkOutState.init, checkOutState.unpaid], null)]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.makePaid, {
        auths: [{
            '#roles': [Roles.ROOT.name]
        }]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.finish, {
        auths: [{
            '#roles': [Roles.ROOT.name]
        }]
            ...
            '#exists': [{
                ...
                condition: function condition(_ref74) {
                    var user = _ref74.user,
                        actionData = _ref74.actionData,
                        roleName = _ref74.roleName;
