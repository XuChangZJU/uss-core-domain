...
var AUTH_MATRIX = {
    ...
    bid: (_bid = {}, (0, _defineProperty3.default)(_bid, bidAction.create, {
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding, bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref76) {
        var row = _ref76.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref77) {
        var row = _ref77.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref78) {
        var row = _ref78.row;
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref85) {
                    var actionData = _ref85.actionData,
                        row = _ref85.row;
                    var paddle = actionData.paddle;
