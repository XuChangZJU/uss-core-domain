...
var AUTH_MATRIX = {
        ...
        auths: [{
            '#exists': [{
                ...
                condition: function condition(_ref18) {
                    ...
                    var userEntityGrant = actionData.userEntityGrant;
    ...
    }), _defineProperty(_vendue, vendueAction.authGrantMulti, {
        auths: [{
            '#exists': [{
                relation: 'userVendue',
                needData: true,
    ...
    }), _defineProperty(_session, sessionAction.authGrantMulti, {
        auths: [{
            '#exists': [{
                relation: 'userSession',
                needData: true,
    ...
    }), _defineProperty(_auctionHouse, auctionHouseAction.authGrantMulti, {
        auths: [{
            '#exists': [{
                relation: 'userAuctionHouse',
                needData: true,
