...
var BidDataCheckStateFn = function BidDataCheckStateFn(states) {
    return {
...
var BidGeneralUpdateControl = function BidGeneralUpdateControl(states, extra) {
    var DataCheck = BidDataCheckStateFn(states);
    var Auth1 = assign({
        "#relation": {
...
var CheckOutPushExistsCheckOut = [{
    ...
    condition: function condition(_ref22) {
        var actionData = _ref22.actionData;
...
var AUTH_MATRIX = {
    ...
    }), (0, _defineProperty3.default)(_auction, auctionAction.remove, AuctionCheckBidUnexistedControl), (0, _defineProperty3.default)(_auction, auctionAction.assign, AllowEveryoneAuth), (0, _defineProperty3.default)(_auction, auctionAction.authRevoke, AllowEveryoneAuth), _auction),
        ...
        auths: [{
            ...
            '#exists': [{
                ...
                condition: function condition(_ref64) {
                    var actionData = _ref64.actionData;
                    var bid = actionData.bid;
    ...
    })), (0, _defineProperty3.default)(_bid, bidAction.remove, BidGeneralUpdateControl([bidState.bidding])), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success])), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success])), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.makeFailure, {
        auths: [{
            "#role": [Roles.ROOT.name],
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref68) {
                    var actionData = _ref68.actionData,
                        row = _ref68.row;
                    var paddle = actionData.paddle;

                    var totalDeposit = paddle.totalDeposit || row.totalDeposit;
                    var availableDeposit = paddle.availableDeposit || row.availableDeposit;
    ...
    checkOut: (_checkOut = {}, (0, _defineProperty3.default)(_checkOut, checkOutAction.takeAway, {
        auths: [CheckOutVendueWorkerCheckFn(checkOutAction.takeAway, null, [checkOutTransportState.unpicked]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.takeAway, null, [checkOutTransportState.unpicked])]
        ...
        auths: [CheckOutGuestCheckFn(checkOutAction.taCancel, null, [checkOutTransportState.tsInPreparing]), CheckOutVendueWorkerCheckFn(checkOutAction.taCancel, null, [checkOutTransportState.tsInPreparing]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.taCancel, null, [checkOutTransportState.tsInPreparing])]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.taSend, {
        auths: [CheckOutVendueWorkerCheckFn(checkOutAction.taSend, null, [checkOutTransportState.tsInPreparing]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.taSend, null, [checkOutTransportState.tsInPreparing])]
    }), (0, _defineProperty3.default)(_checkOut, checkOutAction.taAccept, {
        auths: [CheckOutGuestCheckFn(checkOutAction.taAccept, null, [checkOutTransportState.tsSending])]
        ...
        auths: [CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.makePaid, [checkOutState.unpaid], null)]
