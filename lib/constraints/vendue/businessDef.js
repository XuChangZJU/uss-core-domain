...
var AUTH_MATRIX = {
    ...
    bid: (_bid = {}, (0, _defineProperty3.default)(_bid, bidAction.create, {
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding, bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref73) {
        var row = _ref73.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref74) {
        var row = _ref74.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.makeFailure, {
        auths: [{
            "#role": [Roles.ROOT.name],
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref80) {
                    var actionData = _ref80.actionData,
                        row = _ref80.row;
                    var paddle = actionData.paddle;
            ...
            '#data': [{
                check: function check(_ref81) {
                    var actionData = _ref81.actionData,
                        row = _ref81.row;
                    var paddle = actionData.paddle;
