...
var AUTH_MATRIX = {
    ...
    })), (0, _defineProperty3.default)(_bid, bidAction.remove, BidGeneralUpdateControl([bidState.bidding])), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding, bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success])), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.makeFailure, {
        auths: [{
            "#role": [Roles.ROOT.name],
