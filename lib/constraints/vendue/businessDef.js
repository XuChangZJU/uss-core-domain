...
var AUTH_MATRIX = {
    ...
    auction: (_auction = {}, (0, _defineProperty3.default)(_auction, auctionAction.create, AuctionCreateControl), (0, _defineProperty3.default)(_auction, auctionAction.update, AuctionCheckBidUnexistedControl), (0, _defineProperty3.default)(_auction, auctionAction.ready, {
        ...
        auths: AuctionGeneralStateChangeFn([auctionState.unsold], '非流拍的展品不能重拍')
    }), (0, _defineProperty3.default)(_auction, auctionAction.breakUp, {
        auths: {
            '#relation': {
                attr: 'session.vendue.auctionHouse',
                relations: [auctionHouseRelation.manager, auctionHouseRelation.owner]
            ...
            '#data': [{
                check: function check(_ref68) {
                    ...
                    return ErrorCode.createErrorByCode(ErrorCode.errorDataInconsistency, '只有成交的拍品可以违约', {
                        name: 'auction',
                        operation: 'update',
                        data: row
                    });
    ...
    bid: (_bid = {}, (0, _defineProperty3.default)(_bid, bidAction.create, {
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding, bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref74) {
        var row = _ref74.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref75) {
        var row = _ref75.row;
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref82) {
                    var actionData = _ref82.actionData,
                        row = _ref82.row;
                    var paddle = actionData.paddle;
