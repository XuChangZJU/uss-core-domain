...
var _vendue, _session, _auction, _bid, _paddle, _auctionHouse, _collection, _contract, _stock, _deposit, _checkOut, _cashIn, _license, _qiniuFile, _paymentRecord, _banner;
...
var AUTH_MATRIX = {
    ...
    agent: (0, _defineProperty3.default)({}, agentAction.create, {
        auths: [{
            '#exists': [{
                relation: 'paddle',
                needData: true,
