...
var AUTH_MATRIX = {
    ...
    bid: (_bid = {}, (0, _defineProperty3.default)(_bid, bidAction.create, {
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding, bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref78) {
        var row = _ref78.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref79) {
        var row = _ref79.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref80) {
        var row = _ref80.row;
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref86) {
                    var actionData = _ref86.actionData,
                        row = _ref86.row;
                    var paddle = actionData.paddle;
