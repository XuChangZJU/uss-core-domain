...
var _require24 = require('lodash/omit'),
    omit = _require24.omit;
...
var BidGeneralUpdateControl = function BidGeneralUpdateControl(states, extra, dataCheck) {
...
var AUTH_MATRIX = {
    ...
    bid: (_bid = {}, (0, _defineProperty3.default)(_bid, bidAction.create, {
        ...
        check: function check(_ref72) {
            ...
            if (row.paddleId) {
                return ErrorCode.createErrorByCode(ErrorCode.errorDataInconsistency, '\u53EA\u5141\u8BB8\u53D6\u6D88\u73B0\u573A\u51FA\u4EF7', {
                    name: 'bid',
                    operation: 'update',
                    data: row
                });
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref79) {
                    var actionData = _ref79.actionData,
                        row = _ref79.row;
                    var paddle = actionData.paddle;
        ...
        auths: [{
            ...
            '#unexists': [{
                ...
                condition: function condition(_ref99) {
                    ...
                    var others = omit(agent, ['price', 'id']);
                    assert((0, _keys2.default)(others).length === 0, '只允许修改委托价格');
                    return {
                        price: {
                            $gt: agentPrice
                        },
