...
var _vendue, _session, _auction, _bid, _paddle, _auctionHouse, _collection, _contract, _stock, _deposit, _checkOut, _cashIn, _license, _contractTerms, _agent, _qiniuFile, _paymentRecord;
...
var _require18 = require('../../constants/vendue/paymentRecord'),
    paymentRecordAction = _require18.action;
...
var AUTH_MATRIX = {
    vendue: (_vendue = {}, _defineProperty(_vendue, vendueAction.assign, {
        auths: [{
            "#relation": {
    ...
    }), _defineProperty(_vendue, vendueAction.create, {
        auths: [{
            "exists": [{
                relation: 'userAuctionHouse',
                needData: true,
    ...
    session: (_session = {}, _defineProperty(_session, sessionAction.assign, {
        auths: [{
            "#relation": {
    ...
    }), _defineProperty(_session, sessionAction.create, {
        auths: [{
            "exists": [{
                relation: 'userVendue',
                needData: true,
    ...
    }), _defineProperty(_auction, auctionAction.assign, AllowEveryoneAuth), _defineProperty(_auction, auctionAction.authRevoke, AllowEveryoneAuth), _auction),
    ...
    }), _defineProperty(_bid, bidAction.cancelBidding, {
        auths: [{
            "#relation": {
                attr: 'auction.session',
                relations: [sessionRelation.manager, sessionRelation.auctioneer, sessionRelation.owner]
    ...
    }), _defineProperty(_bid, bidAction.cancelSuccess, {
        auths: [{
            "#relation": {
                attr: 'auction.session',
                relations: [sessionRelation.manager, sessionRelation.auctioneer, sessionRelation.owner]
    ...
    auctionHouse: (_auctionHouse = {}, _defineProperty(_auctionHouse, auctionHouseAction.assign, {
        auths: [{
            "#relation": {
                relations: [auctionHouseRelation.manager, auctionHouseRelation.owner]
            }
        }]
    }), _defineProperty(_auctionHouse, auctionHouseAction.create, AllowEveryoneAuth), _defineProperty(_auctionHouse, auctionHouseAction.update, {
        auths: [{
    ...
    collection: (_collection = {}, _defineProperty(_collection, collectionAction.create, AllowEveryoneAuth), _defineProperty(_collection, collectionAction.update, CollectionOwnerOrAuctionHouseWorker), _defineProperty(_collection, collectionAction.remove, CollectionOwnerOrAuctionHouseWorker), _collection),
    ...
    }), _defineProperty(_checkOut, checkOutAction.cancel, {
        auths: [{
            "#relation": {
                attr: 'paddle'
            }
    ...
    paymentRecord: (_paymentRecord = {}, _defineProperty(_paymentRecord, paymentRecordAction.create, AllowEveryoneAuth), _defineProperty(_paymentRecord, paymentRecordAction.remove, AllowEveryoneAuth), _paymentRecord)
};
