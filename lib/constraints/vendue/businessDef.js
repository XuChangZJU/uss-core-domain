...
var AUTH_MATRIX = {
    ...
    bid: (_bid = {}, (0, _defineProperty3.default)(_bid, bidAction.create, {
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.update, BidGeneralUpdateControl([bidState.bidding, bidState.success, bidState.confirmed])), (0, _defineProperty3.default)(_bid, bidAction.changePrice, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref79) {
        var row = _ref79.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.confirm, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref80) {
        var row = _ref80.row;
        ...
        return true;
    })), (0, _defineProperty3.default)(_bid, bidAction.violate, BidGeneralUpdateControl([bidState.success, bidState.confirmed], {}, function (_ref81) {
        var row = _ref81.row;
        ...
        auths: [{
            ...
            '#data': [{
                check: function check(_ref88) {
                    var actionData = _ref88.actionData,
                        row = _ref88.row;
                    var paddle = actionData.paddle;
    ...
    checkOut: (_checkOut = {}, (0, _defineProperty3.default)(_checkOut, checkOutAction.takeAway, {
        ...
        auths: [CheckOutGuestCheckFn(checkOutAction.update, null, [checkOutTransportState.shipping]), CheckOutVendueWorkerCheckFn(checkOutAction.update, [checkOutState.legal, checkOutState.legal2], [checkOutTransportState.shipping]), CheckOutVendueAuctionHouseWorkerCheckFn(checkOutAction.update, [checkOutState.legal, checkOutState.legal2], [checkOutTransportState.shipping])]
