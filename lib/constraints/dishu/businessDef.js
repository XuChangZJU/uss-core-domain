...
var AUTH_MATRIX = {
    project: (_project = {}, _defineProperty(_project, ProjectAction.makeDead, ProjectOwner), _defineProperty(_project, ProjectAction.createAttendance, ProjectOwner), _defineProperty(_project, ProjectAction.updateAttendance, ProjectOwner), _project)
};
