...
var AUTH_MATRIX = {
    ...
    attendance: (_attendance = {}, _defineProperty(_attendance, AttendanceAction.update, AttendanceProjectOwner), _defineProperty(_attendance, AttendanceAction.complete, AttendanceProjectOwner), _attendance),
    check: _defineProperty({}, CheckAction.update, CheckAttendanceProjectOwner)
};
