...
var AUTH_MATRIX = {
    project: _defineProperty({}, ProjectAction.makeDead, AliveProjectOwner),
    attendance: (_attendance = {}, _defineProperty(_attendance, AttendanceAction.wakeUp, AttendanceProjectOwner), _defineProperty(_attendance, AttendanceAction.update, AttendanceProjectOwner), _defineProperty(_attendance, AttendanceAction.complete, AttendanceProjectOwner), _defineProperty(_attendance, AttendanceAction.create, {
        auths: [{
            '#exists': [{
    ...
    attender: _defineProperty({}, AttenderAction.update, {
        auths: [{
            '#relation': {}
        }, {
            '#relation': {
