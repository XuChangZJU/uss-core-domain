...
var _achievement, _memberAchievement, _project, _memberProject, _star, _comment, _tag;
...
var AUTH_MATRIX = {
    ...
    star: (_star = {}, _defineProperty(_star, StarAction.create, {
        auths: [{
            '#exists': [{
                relation: 'member',
    ...
    }), _defineProperty(_star, StarAction.update, {
        auths: [{
            '#data': [{
