...
var _express, _lgSkuValue, _lgValue, _lgProperty, _lgPropertySpecies, _lgSpecies, _lgBrand, _lgSkuItem, _lgDistrict, _lgMall, _lgShop, _lgWeChatSettlement, _lgSku, _lgTrade, _lgServiceCompany, _enterUp, _lgShoppingCart, _lgSkuItemValue, _lgSkuItemShop;
...
var _require20 = require('../../constants/lg/plate'),
    plateAction = _require20.action;

var _require21 = require('../../constants/lg/tradeSkuItemShop'),
    tradeSkuItemShopAction = _require21.action,
    tradeSkuItemShopState = _require21.state;

var _require22 = require('../../constants/lg/express'),
    expressAction = _require22.action,
    expressState = _require22.state;
...
var AUTH_MATRIX = {
    ...
    }), (0, _defineProperty3.default)(_lgTrade, tradeAction.tradeSend, {
        auths: [{
            "#relation": {
                attr: 'lgShop'
            },
    ...
    }), (0, _defineProperty3.default)(_lgTrade, tradeAction.tradeAccept, {
        auths: [{
            '#data': [{
    ...
    }), (0, _defineProperty3.default)(_lgTrade, tradeAction.tradeReject, {
        auths: [{
            '#data': [{
