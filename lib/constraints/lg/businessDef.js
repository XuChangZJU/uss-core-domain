...
var _lgSkuValue, _lgValue, _lgProperty, _lgPropertySpecies, _lgSpecies, _lgBrand, _lgSkuItem, _lgDistrict, _lgMall, _lgShop, _lgWeChatSettlement, _lgSku, _lgTrade, _lgServiceCompany, _enterUp;
...
var AUTH_MATRIX = {
    ...
    lgServiceCompany: (_lgServiceCompany = {}, _defineProperty(_lgServiceCompany, serviceCompanyAction.create, AllowEveryoneAuth), _defineProperty(_lgServiceCompany, serviceCompanyAction.update, {
        auths: [{
            "#relation": {
                relations: [serviceCompanyRelation.owner, serviceCompanyRelation.manager]
            }
        }]
    }), _defineProperty(_lgServiceCompany, serviceCompanyAction.remove, {
        auths: [{
            "#relation": {
                relations: [serviceCompanyRelation.owner]
            }
        }]
    }), _defineProperty(_lgServiceCompany, serviceCompanyAction.authGrantMulti2, {
        auths: [{
            "#relation": {
                relations: [serviceCompanyRelation.owner, serviceCompanyRelation.manager]
            }
    ...
    enterUp: (_enterUp = {}, _defineProperty(_enterUp, enterUpAction.create, AllowEveryoneAuth), _defineProperty(_enterUp, enterUpAction.update, AnyRelationAuth), _enterUp)
};
