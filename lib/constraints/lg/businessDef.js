...
var _lgShopSpecies, _express, _lgSkuValue, _lgValue, _lgProperty, _lgPropertySpecies, _lgSpecies, _lgBrand, _lgSkuItem, _lgDistrict, _lgMall, _lgShop, _lgWeChatSettlement, _lgSku, _lgTrade, _lgServiceCompany, _enterUp, _lgShoppingCart, _lgSkuItemValue, _lgSkuItemShop, _lgReckoner, _lgTradeRefund;
...
var _require27 = require('../../constants/lg/tradeRefund'),
    TradeRefundAction = _require27.action,
    TradeRefundState = _require27.state,
    TRADEREFUND_STATE_TRANS_MATRIX = _require27.STATE_TRANS_MATRIX;

var _require28 = require('../../constants/lg/tradeSkuItemShopRefund'),
    TradeSkuItemShopRefundAction = _require28.action,
    TradeSkuItemShopRefundState = _require28.state;
        ...
        auths: [{
            '#unexists': [{
                ...
                condition: function condition(_ref77) {
                    var actionData = _ref77.actionData,
                        user = _ref77.user;
