...
var _lgSkuValue, _lgValue, _lgProperty, _lgPropertySpecies, _lgSpecies, _lgBrand, _lgSkuItem, _lgDistrict, _lgMall, _lgShop, _lgWeChatStore, _lgSku, _lgTrade;
...
var _require5 = require('../../constants/lg/weChatStore'),
    weChatStoreAction = _require5.action,
    weChatStoreState = _require5.state,
    weChatStoreRelation = _require5.relation;
...
var AUTH_MATRIX = {
    ...
    lgWeChatStore: (_lgWeChatStore = {}, _defineProperty(_lgWeChatStore, weChatStoreAction.create, {
        auths: [{
            '#exists': [{
                relation: 'userLgShop',
                needData: true,
                condition: function condition(_ref31) {
                    ...
                    var lgWeChatStore = actionData.lgWeChatStore;
    ...
    }), _defineProperty(_lgWeChatStore, weChatStoreAction.update, {
        auths: [{
            "#relation": {
                attr: 'lgShop',
                relations: [shopRelation.owner]
