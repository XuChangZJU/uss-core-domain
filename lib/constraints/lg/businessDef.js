...
var _lgSkuValue, _lgValue, _lgProperty, _lgPropertySpecies, _lgSpecies, _lgBrand, _lgSkuItem, _lgDistrict, _lgMall, _lgShop, _lgWeChatSettlement, _lgSku, _lgTrade, _lgServiceCompany, _enterUp, _lgShoppingCartTerms;
...
var _require17 = require('../../constants/lg/shoppingCartTerms'),
    shoppingCartTermsAction = _require17.action;
...
var AUTH_MATRIX = {
    ...
    lgShoppingCartTerms: (_lgShoppingCartTerms = {}, (0, _defineProperty3.default)(_lgShoppingCartTerms, shoppingCartTermsAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_lgShoppingCartTerms, shoppingCartTermsAction.update, {
        auths: [{
            "#data": [{
    ...
    }), (0, _defineProperty3.default)(_lgShoppingCartTerms, shoppingCartTermsAction.remove, {
        auths: [{
            "#data": [{
