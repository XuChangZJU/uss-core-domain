...
var _lgShopSpecies, _express, _lgSkuValue, _lgValue, _lgProperty, _lgPropertySpecies, _lgSpecies, _lgBrand, _lgSkuItem, _lgDistrict, _lgMall, _lgShop, _lgWeChatSettlement, _lgSku, _lgTrade, _lgServiceCompany, _enterUp, _lgShoppingCart, _lgSkuItemValue, _lgSkuItemShop;
...
var _require2 = require('../../constants/lg/shopSpecies'),
    shopSpeciesAction = _require2.action;

var _require3 = require('../../constants/lg/enterUp'),
    enterUpAction = _require3.action;

var _require4 = require('../../constants/lg/district'),
    districtAction = _require4.action,
    districtRelation = _require4.relation;

var _require5 = require('../../constants/lg/mall'),
    mallAction = _require5.action,
    mallRelation = _require5.relation;

var _require6 = require('../../constants/lg/shop'),
    shopAction = _require6.action,
    shopRelation = _require6.relation,
    SHOP_STATE_TRANS_MATRIX = _require6.STATE_TRANS_MATRIX;

var _require7 = require('../../constants/lg/weChatSettlement'),
    WeChatSettlementAction = _require7.action,
    WeChatSettlementState = _require7.state,
    WeChatSettlementRelation = _require7.relation;

var _require8 = require('../../constants/lg/sku'),
    skuAction = _require8.action,
    skuState = _require8.state,
    SKU_STATE_TRANS_MATRIX = _require8.STATE_TRANS_MATRIX;

var _require9 = require('../../constants/lg/trade'),
    tradeAction = _require9.action,
    tradeTransportState = _require9.transportState,
    tradeState = _require9.state,
    TRADE_STATE_TRANS_MATRIX = _require9.STATE_TRANS_MATRIX;

var _require10 = require('../../constants/lg/skuItem'),
    skuItemAction = _require10.action,
    skuItemState = _require10.state,
    SKUITEM_STATE_TRANS_MATRIX = _require10.STATE_TRANS_MATRIX;

var _require11 = require('../../constants/lg/brand'),
    brandAction = _require11.action;

var _require12 = require('../../constants/lg/species'),
    speciesAction = _require12.action;

var _require13 = require('../../constants/lg/property'),
    propertyAction = _require13.action;

var _require14 = require('../../constants/lg/propertySpecies'),
    propertySpeciesAction = _require14.action;

var _require15 = require('../../constants/lg/value'),
    valueAction = _require15.action;

var _require16 = require('../../constants/lg/skuValue'),
    skuValueAction = _require16.action;

var _require17 = require('../../constants/lg/serviceCompany'),
    serviceCompanyAction = _require17.action,
    serviceCompanyRelation = _require17.relation;

var _require18 = require('../../constants/lg/shoppingCart'),
    shoppingCartAction = _require18.action;

var _require19 = require('../../constants/lg/skuItemValue'),
    skuItemValueAction = _require19.action;

var _require20 = require('../../constants/lg/skuItemShop'),
    skuItemShopAction = _require20.action;

var _require21 = require('../../constants/lg/plate'),
    plateAction = _require21.action;

var _require22 = require('../../constants/lg/tradeSkuItemShop'),
    tradeSkuItemShopAction = _require22.action,
    tradeSkuItemShopState = _require22.state;

var _require23 = require('../../constants/lg/express'),
    expressAction = _require23.action,
    expressState = _require23.state;
...
var AUTH_MATRIX = {
    ...
    express: (_express = {}, (0, _defineProperty3.default)(_express, expressAction.create, AllowEveryoneAuth), (0, _defineProperty3.default)(_express, expressAction.remove, AllowEveryoneAuth), (0, _defineProperty3.default)(_express, expressAction.taAccept, {
        auths: [{
            '#data': [{
