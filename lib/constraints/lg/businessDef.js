...
var AUTH_MATRIX = {
    ...
    }), (0, _defineProperty3.default)(_lgServiceCompany, ServiceCompanyAction.authConfirm, {
        auths: [{
            '#unexists': [{
                relation: 'userLgServiceCompany',
                condition: function condition(_ref62) {
                    var actionData = _ref62.actionData;
                    var userLgServiceCompany = actionData.userLgServiceCompany;
                    var userId = userLgServiceCompany.userId;
