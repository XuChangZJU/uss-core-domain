...
var AUTH_MATRIX = {
    ...
    lgTrade: (_lgTrade = {}, _defineProperty(_lgTrade, skuAction.create, {
        auths: [{
            '#exists': [{
                relation: 'userLgShop',
                needData: true,
    ...
    }), _defineProperty(_lgTrade, skuAction.update, {
        auths: [{
            "#relation": {
                attr: 'lgShop',
                relations: [shopRelation.owner, shopRelation.manager]
    ...
    }), _defineProperty(_lgTrade, skuAction.online, {
        auths: [{
            "#relation": {
                attr: 'lgShop',
                relations: [shopRelation.owner, shopRelation.manager]
    ...
    }), _defineProperty(_lgTrade, skuAction.offline, {
        auths: [{
            "#relation": {
                attr: 'lgShop',
                relations: [shopRelation.owner, shopRelation.manager]
