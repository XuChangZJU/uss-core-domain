...
var AUTH_MATRIX = {
    agency: (_agency = {}, (0, _defineProperty3.default)(_agency, AgencyAction.createSub, {
        auths: [{
    ...
    }), (0, _defineProperty3.default)(_agency, AgencyAction.update, {
    ...
    }), (0, _defineProperty3.default)(_agency, AgencyAction.remove, {
        // visible: 'always',           /*** always: 长显示，none: 不显示 *//
        auths: [{
            '#relation': { // 表示现有对象与user的关系
                show: false, // 置true的话，前台仍然显示按钮
    ...
    }), (0, _defineProperty3.default)(_agency, AgencyAction.setAgencySkuPrice, {
        auths: [{
            '#relation': {
                attr: 'parent',
    ...
    device: (_device = {}, (0, _defineProperty3.default)(_device, DeviceAction.loadGoods, {
        auths: [{
            '#relation': { // 表示现有对象与user的关系
                show: false, // 置true的话，前台仍然显示按钮
    ...
    }), (0, _defineProperty3.default)(_device, DeviceAction.changeCharger, {
        auths: [{
            '#relation': { // 表示现有对象与user的关系
                show: false, // 置true的话，前台仍然显示按钮
                attr: 'agency' // 这里的attr指对象中的属性，通过Schema反查找，如果没有则是指自身，即使用id属性
    ...
    }), (0, _defineProperty3.default)(_device, DeviceAction.remove, {
        auths: [{
            '#relation': { // 表示现有对象与user的关系
                show: false, // 置true的话，前台仍然显示按钮
                attr: 'agency', // 这里的attr指对象中的属性，通过Schema反查找，如果没有则是指自身，即使用id属性
    ...
    }), (0, _defineProperty3.default)(_device, DeviceAction.returnBack, {
        auths: [{
            '#relation': { // 表示现有对象与user的关系
                show: false, // 置true的话，前台仍然显示按钮
                attr: 'agency', // 这里的attr指对象中的属性，通过Schema反查找，如果没有则是指自身，即使用id属性
    ...
    }), (0, _defineProperty3.default)(_device, DeviceAction.grantSubAgency, {
        /**
