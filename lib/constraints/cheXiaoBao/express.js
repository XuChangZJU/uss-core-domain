...
// 状态允许更新矩阵
var StateTransformMatrix = _defineProperty({}, Roles.ROOT.name, (_Roles$ROOT$name = {}, _defineProperty(_Roles$ROOT$name, State.unpost, [State.posted]), _defineProperty(_Roles$ROOT$name, State.posted, [State.sending, State.end]), _defineProperty(_Roles$ROOT$name, State.sending, [State.end]), _Roles$ROOT$name));
