...
// 状态允许更新矩阵
var StateTransformMatrix = (_StateTransformMatrix = {}, _defineProperty(_StateTransformMatrix, Roles.CXBCUSTOMER.name, (_Roles$CXBCUSTOMER$na = {}, _defineProperty(_Roles$CXBCUSTOMER$na, State.init, [State.unpaid, State.cancelled1]), _defineProperty(_Roles$CXBCUSTOMER$na, State.unpaid, [State.cancelled1]), _defineProperty(_Roles$CXBCUSTOMER$na, State.paid, [State.cancelled2, State.arrived]), _Roles$CXBCUSTOMER$na)), _defineProperty(_StateTransformMatrix, Roles.CXBWORKER.name, (_Roles$CXBWORKER$name = {}, _defineProperty(_Roles$CXBWORKER$name, State.arrived, [State.inServe]), _defineProperty(_Roles$CXBWORKER$name, State.inServe, [State.end]), _Roles$CXBWORKER$name)), _defineProperty(_StateTransformMatrix, Roles.ROOT.name, (_Roles$ROOT$name = {}, _defineProperty(_Roles$ROOT$name, State.init, [State.expired]), _defineProperty(_Roles$ROOT$name, State.unpaid, [State.paid, State.expired]), _defineProperty(_Roles$ROOT$name, State.paid, [State.arrived, State.inServe]), _defineProperty(_Roles$ROOT$name, State.arrived, [State.inServe]), _defineProperty(_Roles$ROOT$name, State.inServe, [State.end]), _defineProperty(_Roles$ROOT$name, State.cancelled2, [State.over2]), _Roles$ROOT$name)), _StateTransformMatrix);
