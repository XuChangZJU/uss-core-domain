...
var _require5 = require('../../constants/kefu/orderedService'),
    ...
    orderedServiceRelation = _require5.relation,
    orderedServiceState = _require5.state,
    ORDERED_SERVICE_STATE_TRANS_MATRIX = _require5.STATE_TRANS_MATRIX;

var _require6 = require('../../constants/kefu/phoneNumber'),
    phoneNumberAction = _require6.action,
    phoneNumberRelation = _require6.relation,
    phoneNumberState = _require6.state,
    PHONE_NUMBER_STATE_TRANS_MATRIX = _require6.STATE_TRANS_MATRIX;
...
var AUTH_MATRIX = {
    ...
    }), _defineProperty(_axbBind, axbBindAction.bind, {
        auths: [{
            '#exists': axbBindManager,
            '#data': [{
    ...
    }), _defineProperty(_axbBind, axbBindAction.call, {
        auths: [{
            '#exists': axbBindApiManager,
            '#data': [{
    ...
    }), _defineProperty(_axbBind, axbBindAction.disconnected, {
        auths: [{
            '#exists': axbBindApiManager
        }]
