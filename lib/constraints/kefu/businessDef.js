...
var AUTH_MATRIX = {
    axbBind: (_axbBind = {}, (0, _defineProperty3.default)(_axbBind, axbBindAction.create, {
        auths: [{
            '#exists': [{
                relation: 'orderedService',
                needData: true,
    ...
    }), (0, _defineProperty3.default)(_axbBind, axbBindAction.update, {
        auths: [{
            '#exists': axbBindManager
        }, {
            '#exists': axbBindApiManager
        }]
    }), (0, _defineProperty3.default)(_axbBind, axbBindAction.remove, {
        auths: [{
            '#exists': axbBindManager
        }, {
            '#exists': axbBindApiManager
        }]
    }), (0, _defineProperty3.default)(_axbBind, axbBindAction.unbind, {
        auths: [{
            '#exists': axbBindManager,
            '#data': [{
    ...
    }), (0, _defineProperty3.default)(_axbBind, axbBindAction.expire, {
        auths: [{
            '#exists': axbBindManager,
            '#data': [{
    ...
    company: (_company = {}, (0, _defineProperty3.default)(_company, companyAction.create, {
        auths: [{
            '#relation': {
                relations: [companyRelation.owner]
            }
        }]
    }), (0, _defineProperty3.default)(_company, companyAction.update, {
        auths: [{
            '#relation': {
                relations: [companyRelation.owner]
            }
        }]
    }), (0, _defineProperty3.default)(_company, companyAction.remove, {
        auths: [{
            '#relation': {
                relations: [companyRelation.owner]
            }
        }]
    }), (0, _defineProperty3.default)(_company, companyAction.enable, {
        auths: [{
            '#relation': {
                relations: [companyRelation.owner]
            },
    ...
    }), (0, _defineProperty3.default)(_company, companyAction.disable, {
        auths: [{
            '#relation': {
                relations: [companyRelation.owner]
            },
    ...
    orderedService: (_orderedService = {}, (0, _defineProperty3.default)(_orderedService, orderedServiceAction.update, {
        auths: [{
            '#exists': [orderedServiceApiCompany]
        }, {
            '#relation': orderedServiceCompany
        }]
    }), (0, _defineProperty3.default)(_orderedService, orderedServiceAction.remove, {
        auths: [{
            '#exists': [orderedServiceApiCompany]
        }, {
            '#relation': orderedServiceCompany
        }]
    }), (0, _defineProperty3.default)(_orderedService, orderedServiceAction.subscribe, {
        auths: [{
            '#exists': [orderedServiceApiCompany],
            '#data': [{
    ...
    }), (0, _defineProperty3.default)(_orderedService, orderedServiceAction.unsubscribe, {
        auths: [{
            '#exists': [orderedServiceApiCompany],
            '#data': [{
    ...
    }), (0, _defineProperty3.default)(_orderedService, orderedServiceAction.renew, {
        auths: [{
            '#exists': [orderedServiceApiCompany],
            '#data': [{
