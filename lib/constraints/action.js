...
var StateTransformMatrixForPaid = _defineProperty({}, Roles.ROOT.name, (_Roles$ROOT$name = {}, _defineProperty(_Roles$ROOT$name, State.init, [State.unpaid, State.cancelled, State.expired]), _defineProperty(_Roles$ROOT$name, State.unpaid, [State.legal, State.aborted, State.expired, State.cantPaid]), _defineProperty(_Roles$ROOT$name, State.legal, [State.refunding, State.completed]), _defineProperty(_Roles$ROOT$name, State.refunding, [State.refunded]), _Roles$ROOT$name));
