...
var StateTransformMatrixForPaid = _defineProperty({}, Roles.ROOT.name, (_Roles$ROOT$name = {}, _defineProperty(_Roles$ROOT$name, State.init, [State.unpaid, State.cancelled, State.expired]), _defineProperty(_Roles$ROOT$name, State.unpaid, [State.legal, State.aborted, State.expired]), _Roles$ROOT$name));
