...
var AUTH_MATRIX = {
    ...
    })), _defineProperty(_report, ReportAction.rejectRepairing, genWorker(function (_ref12) {
        var user = _ref12.user,
            row = _ref12.row;

        return [ReportState.askingForRestart].includes(row.state);
    })), _defineProperty(_report, ReportAction.askForRestart, genOwnerOrFactoryOwner(function (_ref13) {
        var user = _ref13.user,
            row = _ref13.row;

        return row.state === ReportState.done;
    })), _defineProperty(_report, ReportAction.restart, genWorker(function (_ref14) {
        var user = _ref14.user,
            row = _ref14.row;

        return row.state === ReportState.askingForRestart;
    })), _defineProperty(_report, ReportAction.surrender, genWorker(function (_ref15) {
