...
var AUTH_MATRIX = {
    ...
    })), _defineProperty(_report, ReportAction.rejectRepairing, genWorker(function (_ref14) {
        var user = _ref14.user,
            row = _ref14.row;

        return [ReportState.askingForRestart].includes(row.state);
    })), _defineProperty(_report, ReportAction.askForRestart, genOwnerOrFactoryOwner(function (_ref15) {
        var user = _ref15.user,
            row = _ref15.row;

        return row.state === ReportState.done;
    })), _defineProperty(_report, ReportAction.restart, genWorker(function (_ref16) {
        var user = _ref16.user,
            row = _ref16.row;

        return row.state === ReportState.askingForRestart;
    })), _defineProperty(_report, ReportAction.surrender, genWorker(function (_ref17) {
