...
function mappingReqToMetadata(req) {
	var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

	var requestOptions = destructRequestOptions(req);
	var options = assign({}, requestOptions, params);
	var metadata = {
...
module.exports = {
	...
	mappingReqToMetadata: mappingReqToMetadata
};