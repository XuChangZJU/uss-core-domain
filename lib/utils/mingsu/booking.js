...
function destructInterval(startsAt, endsAt) {
    var CONFIG = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { HighSeasonStart: { month: 5, day: 1 }, HighSeasonEnd: { month: 10, day: 15 } };
    ...
    if (mStart.year() < mEnd.year()) {
        ...
        var holidays = CONFIG.getHolidays(mStart.year());
        ...
        var holidays2 = CONFIG.getHolidays(mEnd.year());
        ...
        var _holidays = CONFIG.getHolidays(mStart.year());
