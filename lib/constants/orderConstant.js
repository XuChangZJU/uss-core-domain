...
var decodeType = function decodeType(t) {
    ...
    var STRING_OF_TYPES = (_STRING_OF_TYPES = {}, _defineProperty(_STRING_OF_TYPES, type.coupon, "红包"), _defineProperty(_STRING_OF_TYPES, type.weChatProOrder, "订单"), _defineProperty(_STRING_OF_TYPES, type.bonus, '奖金'), _defineProperty(_STRING_OF_TYPES, type.goods, '货款'), _defineProperty(_STRING_OF_TYPES, type.couponRefund, '红包退款'), _STRING_OF_TYPES);
