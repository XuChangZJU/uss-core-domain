...
var decodeAction = function decodeAction(s) {
    ...
    var S = (_S2 = {}, _defineProperty(_S2, action.initialize, '初始化'), _defineProperty(_S2, action.update, '更新'), _defineProperty(_S2, action.normalize, '正常化'), _defineProperty(_S2, action.disconnect, '断连'), _defineProperty(_S2, action.connect, '连接'), _defineProperty(_S2, action.disable, '禁用'), _defineProperty(_S2, action.enable, '启用'), _defineProperty(_S2, action.loadGoods, '增加货物'), _defineProperty(_S2, action.grantSubAgency, '授予下级'), _defineProperty(_S2, action.returnBack, '归还上级'), _defineProperty(_S2, action.changeCharger, '修改电桩设置'), _S2);
