...
var decodeEvent = function decodeEvent(e) {
    ...
    var S = (_S3 = {}, _defineProperty(_S3, event.workSuccess, '工作成功'), _defineProperty(_S3, event.workFailure, '工作失败'), _defineProperty(_S3, event.stopSuccess, '停止成功'), _defineProperty(_S3, event.stopFailure, '停止失败'), _defineProperty(_S3, event.querySuccess, '查询成功'), _defineProperty(_S3, event.report, '汇报数据'), _defineProperty(_S3, event.deviceConnected, '重新连接'), _defineProperty(_S3, event.deviceDisconnected, '失去连接'), _defineProperty(_S3, event.deviceConnectedByBle, '通过蓝牙连接'), _S3);
    return S[e];
};
