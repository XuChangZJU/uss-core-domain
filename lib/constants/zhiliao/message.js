...
var STATE_TRANS_MATRIX = (_STATE_TRANS_MATRIX = {}, (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.send, [state.unsent, state.unread]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.read, [state.unread, state.read]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.withdraw, [[state.unread, state.read], state.withdrawn]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.conceal, [[state.unread, state.read], state.cancelled]), _STATE_TRANS_MATRIX);
module.exports = {
    relation: relation,
