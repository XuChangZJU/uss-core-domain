...
var decodeType = function decodeType(d) {
    var _D;

    var D = (_D = {}, (0, _defineProperty3.default)(_D, type.text, '文本'), (0, _defineProperty3.default)(_D, type.photo, '照片'), (0, _defineProperty3.default)(_D, type.file, '文件'), (0, _defineProperty3.default)(_D, type.video, '视频'), (0, _defineProperty3.default)(_D, type.voice, '语音'), _D);
    return D[d];
};
