...
var decodeState = function decodeState(s) {
    ...
    var TEXT = (_TEXT = {}, _defineProperty(_TEXT, state.delivered, '已派单'), _defineProperty(_TEXT, state.accepted, '已接单'), _defineProperty(_TEXT, state.inRepairing, '维修中'), _defineProperty(_TEXT, state.done, '已修好'), _defineProperty(_TEXT, state.committed, '待确认'), _defineProperty(_TEXT, state.askingForRestart, '申请重修'), _defineProperty(_TEXT, state.inRedoing, '确认重修'), _defineProperty(_TEXT, state.failed, '维修失败'), _defineProperty(_TEXT, state.cancelled2, '已取消'), _TEXT);
...
var decodeAction = function decodeAction(s) {
    ...
    var TEXT = (_TEXT2 = {}, _defineProperty(_TEXT2, action.confirm, '确认'), _defineProperty(_TEXT2, action.accept, '接单'), _defineProperty(_TEXT2, action.deliverAgain, '再次派单'), _defineProperty(_TEXT2, action.giveUp, '放弃接单'), _defineProperty(_TEXT2, action.startRepairing, '开始维修'), _defineProperty(_TEXT2, action.endRepairing, '维修完成'), _defineProperty(_TEXT2, action.commit, '提交完成'), _defineProperty(_TEXT2, action.admit, '确认完成'), _defineProperty(_TEXT2, action.askForRestart, '申请返修'), _defineProperty(_TEXT2, action.restart, '再次开始维修'), _defineProperty(_TEXT2, action.rejectRepairing, '拒绝维修'), _defineProperty(_TEXT2, action.surrender, '放弃维修'), _TEXT2);
