...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, _defineProperty(_STATE_TRAN_MATRIX, action.confirm, [state.init, state.delivered]), _defineProperty(_STATE_TRAN_MATRIX, action.accept, [state.delivered, state.accepted]), _defineProperty(_STATE_TRAN_MATRIX, action.deliverAgain, [state.accepted, state.delivered]), _defineProperty(_STATE_TRAN_MATRIX, action.giveUp, [state.accepted, state.delivered]), _defineProperty(_STATE_TRAN_MATRIX, action.startRepairing, [state.accepted, state.inRepairing]), _defineProperty(_STATE_TRAN_MATRIX, action.endRepairing, [[state.inRepairing, state.inRedoing], state.done]), _defineProperty(_STATE_TRAN_MATRIX, action.askForRestart, [state.done, state.askingForRestart]), _defineProperty(_STATE_TRAN_MATRIX, action.restart, [state.askingForRestart, state.inRedoing]), _defineProperty(_STATE_TRAN_MATRIX, action.surrender, [[state.inRepairing, state.inRedoing], state.failed]), _defineProperty(_STATE_TRAN_MATRIX, action.expire, [state.init, state.expired]), _defineProperty(_STATE_TRAN_MATRIX, action.cancel, [[state.init, state.delivered, state.accepted, state.expired], state.cancelled2]), _STATE_TRAN_MATRIX);
