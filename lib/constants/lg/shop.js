...
var decodeState = function decodeState(s) {
    ...
    var TEXT = (_TEXT = {}, _defineProperty(_TEXT, state.online, '上线中'), _defineProperty(_TEXT, state.offline, '下线中'), _defineProperty(_TEXT, state.disabled, '禁用中'), _TEXT);
...
var decodeAction = function decodeAction(a) {
    ...
    var TEXT = (_TEXT3 = {}, _defineProperty(_TEXT3, action.online, '上线'), _defineProperty(_TEXT3, action.offline, '下线'), _defineProperty(_TEXT3, action.disable, '禁用'), _defineProperty(_TEXT3, action.able, '启用'), _TEXT3);
...
var STATE_TRANS_MATRIX = (_STATE_TRANS_MATRIX = {}, _defineProperty(_STATE_TRANS_MATRIX, action.online, [state.offline, state.online]), _defineProperty(_STATE_TRANS_MATRIX, action.offline, [state.online, state.offline]), _defineProperty(_STATE_TRANS_MATRIX, action.disable, [[state.online, state.offline], state.disabled]), _defineProperty(_STATE_TRANS_MATRIX, action.able, [state.disabled, state.online]), _STATE_TRANS_MATRIX);
