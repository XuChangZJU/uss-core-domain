...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TEXT = (_TEXT = {}, (0, _defineProperty3.default)(_TEXT, transportState.unsend, '未发货'), (0, _defineProperty3.default)(_TEXT, transportState.unpicked, '待提货'), (0, _defineProperty3.default)(_TEXT, transportState.picked, '已提货'), _TEXT);
...
var decodeAction = function decodeAction(a) {
    var TEXT = (0, _defineProperty3.default)({}, action.pick, '确认提货');
    return TEXT[a] || decodeCommonAction(a) || decodeTransportAction(a);
};

var STATE_TRANS_MATRIX = (0, _assign2.default)({}, COMMON_STATE_TRAN_MATRIX, TRANSPORT_STATE_TRANS_MATRIX, (_Object$assign2 = {}, (0, _defineProperty3.default)(_Object$assign2, action.pick, [transportState.unpicked, transportState.picked]), (0, _defineProperty3.default)(_Object$assign2, action.taPrepare, [transportState.unsend, transportState.tsInPreparing]), (0, _defineProperty3.default)(_Object$assign2, action.taCancel, [transportState.tsInPreparing, transportState.unsend]), _Object$assign2));
