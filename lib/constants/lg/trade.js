...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TEXT = (_TEXT = {}, (0, _defineProperty3.default)(_TEXT, transportState.unsend, '快递未支付'), (0, _defineProperty3.default)(_TEXT, transportState.unpicked, '待提货'), (0, _defineProperty3.default)(_TEXT, transportState.picked, '已提货'), _TEXT);
...
var STATE_TRANS_MATRIX = (0, _assign2.default)({}, COMMON_STATE_TRAN_MATRIX, TRANSPORT_STATE_TRANS_MATRIX, (0, _defineProperty3.default)({}, action.confirmArrive, [transportState.unpicked, transportState.picked]));
