...
var decodeAction = function decodeAction(a) {
    ...
    var TEXT = (_TEXT2 = {}, (0, _defineProperty3.default)(_TEXT2, action.sendExpress, '发快递'), (0, _defineProperty3.default)(_TEXT2, action.confirmArrive, '确认收货'), _TEXT2);

    return TEXT[a] || decodeCommonAction(a);
};

var STATE_TRANS_MATRIX = (0, _assign2.default)({}, COMMON_STATE_TRAN_MATRIX, (_Object$assign2 = {}, (0, _defineProperty3.default)(_Object$assign2, action.send, [transportState.unsend, transportState.sending]), (0, _defineProperty3.default)(_Object$assign2, action.confirmArrive, [transportState.sending, transportState.arrived]), _Object$assign2));
