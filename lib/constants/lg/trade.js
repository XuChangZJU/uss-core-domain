...
var decodeAction = function decodeAction(a) {
    ...
    var TEXT = (_TEXT = {}, (0, _defineProperty3.default)(_TEXT, action.sendExpress, '发快递'), (0, _defineProperty3.default)(_TEXT, action.confirmArrive, '确认提货'), _TEXT);

    return TEXT[a] || decodeCommonAction(a) || decodeTransportAction(a);
};

var STATE_TRANS_MATRIX = (0, _assign2.default)({}, COMMON_STATE_TRAN_MATRIX, TRANSPORT_STATE_TRANS_MATRIX, {});
