...
var decodeState = function decodeState(s) {
    ...
    var TEXT = (_TEXT = {}, _defineProperty(_TEXT, state.online, '已上架'), _defineProperty(_TEXT, state.offline, '已下架'), _TEXT);
...
var decodeAction = function decodeAction(a) {
    ...
    var TEXT = (_TEXT2 = {}, _defineProperty(_TEXT2, action.online, '上架'), _defineProperty(_TEXT2, action.offline, '下架'), _TEXT2);
