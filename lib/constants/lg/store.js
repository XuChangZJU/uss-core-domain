...
var decodeState = function decodeState(s) {
    ...
    var TEXT = (_TEXT = {}, _defineProperty(_TEXT, state.approved, '审核已通过'), _defineProperty(_TEXT, state.checking, '审核中'), _defineProperty(_TEXT, state.failed, '审核未通过'), _defineProperty(_TEXT, state.fresh, '未审核'), _TEXT);
    return TEXT[s];
};
