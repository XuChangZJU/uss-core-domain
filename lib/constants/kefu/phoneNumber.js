...
var decodeAction = function decodeAction(a) {
    ...
    var A = (_A = {}, _defineProperty(_A, action.bind, '绑定'), _defineProperty(_A, action.unbind, '解绑'), _defineProperty(_A, action.arrear, '欠费'), _defineProperty(_A, action.halt, '停机'), _A);
