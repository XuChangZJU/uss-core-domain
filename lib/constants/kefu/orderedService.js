...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, _defineProperty(_S, state.subscribed, '已订阅'), _defineProperty(_S, state.unsubscribed, '未订阅'), _S);
