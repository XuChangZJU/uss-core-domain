...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.accept, [state.pending, state.accepted]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.refuse, [state.pending, state.refused]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.resubmit, [state.refused, state.pending]), _STATE_TRAN_MATRIX);
module.exports = {
    action: action,
