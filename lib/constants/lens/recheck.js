...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, _defineProperty(_S, state.inactive, '未到期'), _defineProperty(_S, state.active, '已到期'), _defineProperty(_S, state.confirmed, '已确认'), _defineProperty(_S, state.completed, '已完成'), _defineProperty(_S, state.expired, '已过期'), _defineProperty(_S, state.killed, '已回绝'), _S);
