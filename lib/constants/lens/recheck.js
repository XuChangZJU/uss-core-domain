...
var STATE_TRANS_MATRIX = (_STATE_TRANS_MATRIX = {}, (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.activate, [state.inactive, state.active]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.confirm, [[state.inactive, state.active], state.confirmed]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.complete, [[state.inactive, state.active, state.confirmed, state.expired], state.completed]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.expire, [[state.active, state.confirmed], state.expired]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.makeDead, [state.expired, state.dead]), _STATE_TRANS_MATRIX);
