...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, _defineProperty(_S, state.inactive, '未到复查时间'), _defineProperty(_S, state.active, '已到复查时间'), _defineProperty(_S, state.confirmed, '已确认'), _defineProperty(_S, state.completed, '已完成'), _defineProperty(_S, state.expired, '已过期'), _defineProperty(_S, state.killed, '已被回绝'), _S);
