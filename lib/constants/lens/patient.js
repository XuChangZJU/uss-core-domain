...
var decodeRelation = function decodeRelation(r) {
    ...
    var S = (_S = {}, _defineProperty(_S, relation.owner, '本人'), _defineProperty(_S, relation.parent, '父/母'), _defineProperty(_S, relation.mate, '配偶'), _defineProperty(_S, relation.eldership, '长辈'), _defineProperty(_S, relation.sibling, '兄弟姐妹'), _defineProperty(_S, relation.friend, '朋友'), _defineProperty(_S, relation.children, '子女'), _defineProperty(_S, relation.grandchildren, '晚辈'), _defineProperty(_S, relation.patient, '患者'), _defineProperty(_S, relation.partner, '相关者'), _S);
