...
var decodeCategory = function decodeCategory(c) {
    ...
    var C = (_C = {}, _defineProperty(_C, category.makeGlasses, '配镜'), _defineProperty(_C, category.OKGlasses, '角膜塑形镜'), _defineProperty(_C, category.DoneGlasses, '成镜'), _defineProperty(_C, category.consumables, '耗品'), _defineProperty(_C, category.visionTraining, '视训'), _defineProperty(_C, category.makeGlassesRecheck, '配镜复查'), _defineProperty(_C, category.OKGlassesRecheck, '角膜塑形镜复查'), _defineProperty(_C, category.visionTrainingRecheck, '视训复查'), _C);
    return C[c];
};
