...
var decodeCategory = function decodeCategory(c) {
    ...
    var C = (_C = {}, _defineProperty(_C, category.配镜, 1), _defineProperty(_C, category.角膜塑形镜, 2), _defineProperty(_C, category.成镜, 3), _defineProperty(_C, category.耗品, 4), _defineProperty(_C, category.视训, 5), _defineProperty(_C, category.配镜复查, 6), _defineProperty(_C, category.角膜塑形镜复查, 7), _defineProperty(_C, category.视训复查, 8), _C);
    return C[c];
};
