...
var decodeCategory = function decodeCategory(c) {
    ...
    var C = (_C = {}, _defineProperty(_C, category.normal, '普通业务'), _defineProperty(_C, category.OKGlasses, '角膜塑形镜业务'), _defineProperty(_C, category.check, '检查'), _C);
    return C[c];
};
...
var decodeRelation = function decodeRelation(r) {
    ...
    var T = (_T = {}, _defineProperty(_T, relation.seller, '营业员'), _defineProperty(_T, relation.doctor, '验光医生'), _defineProperty(_T, relation.VIP, 'VIP顾客'), _defineProperty(_T, relation.regularCostomer, '熟客'), _defineProperty(_T, relation.hospitalInsider, '医院内部人士'), _defineProperty(_T, relation.others, '其他'), _T);
