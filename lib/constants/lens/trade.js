...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TS = (_TS = {}, _defineProperty(_TS, transportState.wdd, '未到店'), _defineProperty(_TS, transportState.dqj, '待取件（到店）'), _defineProperty(_TS, transportState.yfh, '已发货'), _defineProperty(_TS, transportState.yqj, '已取件'), _defineProperty(_TS, transportState.yth, '已退货'), _defineProperty(_TS, transportState.yzf, '已作废'), _defineProperty(_TS, transportState.dxh, '待销号'), _TS);
    return TS[ts];
};
