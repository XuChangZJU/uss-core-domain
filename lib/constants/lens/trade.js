...
var getMainCategory = function getMainCategory(c) {
    ...
    var C = (_C2 = {}, (0, _defineProperty3.default)(_C2, category.makeGlasses, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.OKGlasses, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.DoneGlasses, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.consumables, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.visionTraining, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.check, mainCategory.check), (0, _defineProperty3.default)(_C2, category.DISCGlasses, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.SCL, mainCategory.makeBill), (0, _defineProperty3.default)(_C2, category.OkGlassCheck, mainCategory.check), (0, _defineProperty3.default)(_C2, category.doctorService, mainCategory.check), (0, _defineProperty3.default)(_C2, category.visionTrainingCheck, mainCategory.check), (0, _defineProperty3.default)(_C2, category.service, mainCategory.others), (0, _defineProperty3.default)(_C2, category.gift, mainCategory.makeBill), _C2);
    return C[c];
};
...
var getCategory = function getCategory(mc) {
    ...
    var MC = (_MC2 = {}, (0, _defineProperty3.default)(_MC2, mainCategory.makeBill, [category.makeGlasses, category.OKGlasses, category.visionTraining, category.DISCGlasses, category.SCL, category.gift, category.DoneGlasses, category.consumables]), (0, _defineProperty3.default)(_MC2, mainCategory.check, [category.OkGlassCheck, category.visionTrainingCheck, category.check, category.doctorService]), (0, _defineProperty3.default)(_MC2, mainCategory.others, [category.service]), _MC2);
    return MC[mc];
};
