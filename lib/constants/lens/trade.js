...
var getCategory = function getCategory(mc) {
    ...
    var MC = (_MC2 = {}, _defineProperty(_MC2, mainCategory.makeBill, [category.makeGlasses, category.OKGlasses, category.visionTraining, category.DISCGlasses, category.SCL, category.gift]), _defineProperty(_MC2, mainCategory.check, [category.OkGlassCheck, category.visionTrainingCheck, category.check, category.doctorService]), _defineProperty(_MC2, mainCategory.others, [category.service]), _MC2);
    return MC[mc];
};
