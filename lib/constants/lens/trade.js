...
var decodeAction = function decodeAction(a) {
    ...
    var S = (_S = {}, _defineProperty(_S, action.confirmArriveAtShop, '确认到店'), _defineProperty(_S, action.confirmGet, '确认取货'), _defineProperty(_S, action.send, '发快递'), _defineProperty(_S, action.getAndSendMessage, '确认取走并发推送'), _S);

    return S[a] || decodeCommonAction(a);
};

var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, _defineProperty(_STATE_TRAN_MATRIX, action.confirmArriveAtShop, [[transportState.dfl, transportState.dzdjh, transportState.dqhcl], state.dqj]), _defineProperty(_STATE_TRAN_MATRIX, action.confirmGet, [transportState.dqj, transportState.yqj]), _defineProperty(_STATE_TRAN_MATRIX, action.send, [[transportState.dfl, transportState.dzdjh, transportState.dqhcl], state.dqj]), _STATE_TRAN_MATRIX);
module.exports = {
    action: action,
