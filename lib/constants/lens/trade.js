...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TS = (_TS = {}, (0, _defineProperty3.default)(_TS, transportState.wdd, '未到店'), (0, _defineProperty3.default)(_TS, transportState.dqj, '已到店'), (0, _defineProperty3.default)(_TS, transportState.dgkqr, '待顾客确认'), (0, _defineProperty3.default)(_TS, transportState.yqj, '已取件'), (0, _defineProperty3.default)(_TS, transportState.yth, '已退货'), (0, _defineProperty3.default)(_TS, transportState.checkInQueue, '待检查'), (0, _defineProperty3.default)(_TS, transportState.checkCompleted, '已完成'), (0, _defineProperty3.default)(_TS, transportState.checkCanceled, '已取消'), _TS);
...
var decodeGetMethodId = function decodeGetMethodId(gm) {
    ...
    var GM = (_GM = {}, (0, _defineProperty3.default)(_GM, getMethodId.HelpYourself, '顾客自取'), (0, _defineProperty3.default)(_GM, getMethodId.Express, '快递'), (0, _defineProperty3.default)(_GM, getMethodId.AtOnce, '当场立取'), (0, _defineProperty3.default)(_GM, getMethodId.packageDeliver, '委托代收'), _GM);
