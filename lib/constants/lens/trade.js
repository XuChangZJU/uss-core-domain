...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TS = (_TS = {}, (0, _defineProperty3.default)(_TS, transportState.wdd, '未到店'), (0, _defineProperty3.default)(_TS, transportState.dqj, '待取件（到店）'), (0, _defineProperty3.default)(_TS, transportState.dgkqr, '待顾客确认'), (0, _defineProperty3.default)(_TS, transportState.yqj, '已取件'), (0, _defineProperty3.default)(_TS, transportState.yth, '已退货'), (0, _defineProperty3.default)(_TS, transportState.checkInQueue, '待检查'), (0, _defineProperty3.default)(_TS, transportState.checkCompleted, '已完成'), (0, _defineProperty3.default)(_TS, transportState.checkCanceled, '已取消'), _TS);
...
var decodeGetMethodId = function decodeGetMethodId(gm) {
    ...
    var GM = (_GM = {}, (0, _defineProperty3.default)(_GM, getMethodId.HelpYourself, '顾客自取'), (0, _defineProperty3.default)(_GM, getMethodId.Express, '快递'), (0, _defineProperty3.default)(_GM, getMethodId.AtOnce, '当场立取'), _GM);
...
var STATE_TRAN_MATRIX = (0, _assign2.default)({}, COMMON_STATE_TRAN_MATRIX, TRANSPORT_STATE_TRANS_MATRIX, (_Object$assign2 = {}, (0, _defineProperty3.default)(_Object$assign2, action.taPrepare, [transportState.wdd, transportState.tsInPreparing]), (0, _defineProperty3.default)(_Object$assign2, action.taCancel, [transportState.tsInPreparing, transportState.wdd]), (0, _defineProperty3.default)(_Object$assign2, action.financialRefund, [[state.legal2, state.legal, state.abandoned], state.financialRefunded]), (0, _defineProperty3.default)(_Object$assign2, action.confirmArriveAtShop, [transportState.wdd, transportState.dqj]), (0, _defineProperty3.default)(_Object$assign2, action.confirmPick, [transportState.dqj, transportState.dgkqr]), (0, _defineProperty3.default)(_Object$assign2, action.customConfirm, [transportState.dgkqr, transportState.yqj]), (0, _defineProperty3.default)(_Object$assign2, action.completeCheck, [transportState.checkInQueue, transportState.checkCompleted]), (0, _defineProperty3.default)(_Object$assign2, action.cancelCheck, [transportState.checkInQueue, transportState.checkCanceled]), (0, _defineProperty3.default)(_Object$assign2, action.issueBill, [[billState.noBill, billState.pending], billState.pending]), (0, _defineProperty3.default)(_Object$assign2, action.completeBill, [billState.pending, billState.done]), _Object$assign2));
...
var decodeCategoryId = function decodeCategoryId(c) {
    ...
    var C = (_C = {}, (0, _defineProperty3.default)(_C, categoryId.Glasses, '框架眼镜'), (0, _defineProperty3.default)(_C, categoryId.OKGlasses, '角膜塑形镜'), (0, _defineProperty3.default)(_C, categoryId.DoneGlasses, '成镜'), (0, _defineProperty3.default)(_C, categoryId.Others, '其它'), (0, _defineProperty3.default)(_C, categoryId.Training, '视训'), (0, _defineProperty3.default)(_C, categoryId.Check, '验光检查'), (0, _defineProperty3.default)(_C, categoryId.DISCGlasses, '多焦软镜'), (0, _defineProperty3.default)(_C, categoryId.BandgeGlasses, '绷带镜'), (0, _defineProperty3.default)(_C, categoryId.OkGlassTry, '角膜塑形镜初查'), (0, _defineProperty3.default)(_C, categoryId.Service, '医生问诊'), (0, _defineProperty3.default)(_C, categoryId.TrainingCheck, '弱视检查'), (0, _defineProperty3.default)(_C, categoryId.Service, '服务/线下宣讲'), (0, _defineProperty3.default)(_C, categoryId.Gift, '赠品'), (0, _defineProperty3.default)(_C, categoryId.OkGlassRecheck, '角膜塑形镜复查'), (0, _defineProperty3.default)(_C, categoryId.CareLiquid, '护理液'), (0, _defineProperty3.default)(_C, categoryId.Food, '眼保健食品'), (0, _defineProperty3.default)(_C, categoryId.OkGlassFetch, '角膜塑形镜试戴'), _C);
    return C[c];
};
