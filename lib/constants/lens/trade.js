...
var decodeAction = function decodeAction(a) {
    ...
    var S = (_S = {}, _defineProperty(_S, action.confirmArriveAtShop, '确认到店'), _defineProperty(_S, action.confirmGet, '确认收货'), _defineProperty(_S, action.send, '发快递'), _defineProperty(_S, action.updateFeedback, '更新评价'), _defineProperty(_S, action.customerConfirm, '顾客确认'), _defineProperty(_S, action.confirmPick, '确认取货'), _S);

    return S[a] || decodeCommonAction(a);
};

var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, _defineProperty(_STATE_TRAN_MATRIX, action.confirmArriveAtShop, [transportState.wdd, transportState.dqj]), _defineProperty(_STATE_TRAN_MATRIX, action.confirmGet, [transportState.yfh, transportState.yqj]), _defineProperty(_STATE_TRAN_MATRIX, action.confirmPick, [transportState.dqj, transportState.dgkqr]), _defineProperty(_STATE_TRAN_MATRIX, action.customerConfirm, [transportState.dgkqr, transportState.yqj]), _defineProperty(_STATE_TRAN_MATRIX, action.send, [transportState.wdd, transportState.yfh]), _STATE_TRAN_MATRIX);
