...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TS = (_TS = {}, _defineProperty(_TS, transportState.dfl, '待发料'), _defineProperty(_TS, transportState.dzdjh, '定做待缴回'), _defineProperty(_TS, transportState.dqhcl, '待缺货处理'), _defineProperty(_TS, transportState.dqj, '已发货'), _defineProperty(_TS, transportState.ydd, '已到店'), _defineProperty(_TS, transportState.yqj, '已取件'), _defineProperty(_TS, transportState.tdywc, '退单已完成'), _defineProperty(_TS, transportState.yth, '已退货'), _defineProperty(_TS, transportState.yzf, '已作废'), _defineProperty(_TS, transportState.tddcksh, '退单待仓库审核'), _TS);
    return TS[ts];
};
...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, _defineProperty(_STATE_TRAN_MATRIX, action.confirmArriveAtShop, [[transportState.dfl, transportState.dzdjh, transportState.dqhcl], transportState.ydd]), _defineProperty(_STATE_TRAN_MATRIX, action.confirmGet, [transportState.ydd, transportState.yqj]), _defineProperty(_STATE_TRAN_MATRIX, action.confirmPick, [[transportState.dqj], transportState.yqj]), _defineProperty(_STATE_TRAN_MATRIX, action.send, [[transportState.dfl, transportState.dzdjh, transportState.dqhcl, transportState.ydd], transportState.dqj]), _STATE_TRAN_MATRIX);
module.exports = {
    action: action,
