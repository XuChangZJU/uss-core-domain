...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, (0, _defineProperty3.default)(_S, state.ongoing, '进行中'), (0, _defineProperty3.default)(_S, state.finished, '已完成'), (0, _defineProperty3.default)(_S, state.cancelled, '已取消'), _S);
    return S[s];
};
