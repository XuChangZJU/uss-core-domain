...
var STATE_TRANS_MATRIX = (_STATE_TRANS_MATRIX = {}, (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.regist, [[state.normal, state.late], state.completed]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.checkEnd, [[state.normal, state.completed], state.checkEnd]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.cancel, [state.normal, state.cancelled]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.makeLate, [[state.normal, state.late], state.late]), (0, _defineProperty3.default)(_STATE_TRANS_MATRIX, action.makeAbsent, [[state.normal, state.late], state.absent]), _STATE_TRANS_MATRIX);
...
var decodeRelation = function decodeRelation(r) {
    var R = (0, _defineProperty3.default)({}, relation.doctor, '医生');
