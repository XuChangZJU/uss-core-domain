...
var decodeAction = function decodeAction(a) {
    ...
    var TEXT = (_TEXT3 = {}, _defineProperty(_TEXT3, action.activate, '激活'), _defineProperty(_TEXT3, action.online, '上线'), _defineProperty(_TEXT3, action.offline, '下线'), _defineProperty(_TEXT3, action.bind, '绑定'), _defineProperty(_TEXT3, action.unbind, '下线'), _TEXT3);
