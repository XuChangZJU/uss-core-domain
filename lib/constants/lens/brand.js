...
var decodeRelation = function decodeRelation(r) {
    ...
    var S = (_S = {}, _defineProperty(_S, relation.worker, '工作人员'), _defineProperty(_S, relation.customerService, '运营人员'), _defineProperty(_S, relation.seller, '验光师'), _defineProperty(_S, relation.financialStuff, '财务人员'), _defineProperty(_S, relation.doctor, '医生'), _defineProperty(_S, relation.OKGlassesDoctor, '角膜塑形镜验配师'), _defineProperty(_S, relation.visionTrainingDoctor, '视觉训练师'), _defineProperty(_S, relation.supporter, '客服'), _S);

    return S[r] || decodeCommonRelation(r);
};
var everyOneAbleCategory = [category.check, category.consumables, category.DoneGlasses, category.DISCGlasses, category.SCL, category.makeGlasses, category.OkGlassCheck];
