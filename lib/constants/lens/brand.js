...
var relationCategory = (_relationCategory = {}, _defineProperty(_relationCategory, relation.owner, everyOneAbleCategory), _defineProperty(_relationCategory, relation.manager, everyOneAbleCategory), _defineProperty(_relationCategory, relation.worker, everyOneAbleCategory), _defineProperty(_relationCategory, relation.seller, everyOneAbleCategory), _defineProperty(_relationCategory, relation.customerService, everyOneAbleCategory), _defineProperty(_relationCategory, relation.financialStuff, everyOneAbleCategory), _defineProperty(_relationCategory, relation.doctor, everyOneAbleCategory.concat([category.doctorService])), _defineProperty(_relationCategory, relation.OKGlassesDoctor, everyOneAbleCategory.concat([category.OKGlasses, category.OkGlassCheck])), _defineProperty(_relationCategory, relation.visionTrainingDoctor, everyOneAbleCategory.concat([category.visionTraining, category.visionTrainingCheck])), _relationCategory);
module.exports = {
