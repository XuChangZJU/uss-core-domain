...
var decodeType = function decodeType(s) {
    var _S3;

    var S = (_S3 = {}, (0, _defineProperty3.default)(_S3, type.recheck, '邀请复查'), (0, _defineProperty3.default)(_S3, type.appointment, '询问预约未到原因'), _S3);
    return S[s];
};
