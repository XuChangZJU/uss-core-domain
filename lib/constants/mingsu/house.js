...
var decodeSpec = function decodeSpec(s, lang) {
    ...
    var STRING = (_STRING5 = {}, _defineProperty(_STRING5, spec.single, '单人间'), _defineProperty(_STRING5, spec.double, '双人间'), _defineProperty(_STRING5, spec.bigBed, '大床房'), _defineProperty(_STRING5, spec.childish, '儿童房'), _defineProperty(_STRING5, spec.zotheca, '套房'), _defineProperty(_STRING5, spec.distinctive, '特色房'), _STRING5);
    return STRING[s];
};
