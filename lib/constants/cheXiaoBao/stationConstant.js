...
var decodeType = function decodeType(t) {
    ...
    var STRINGS = (_STRINGS = {}, (0, _defineProperty3.default)(_STRINGS, type.check, '检查站'), (0, _defineProperty3.default)(_STRINGS, type.materialCheck, '服务站'), _STRINGS);
...
var decodeState = function decodeState(ws) {
    ...
    var STRINGS = (_STRINGS2 = {}, (0, _defineProperty3.default)(_STRINGS2, state.online, '在线'), (0, _defineProperty3.default)(_STRINGS2, state.offline, '停业'), (0, _defineProperty3.default)(_STRINGS2, state.closed, '关闭'), _STRINGS2);
...
var decodeWorkerState = function decodeWorkerState(ws) {
    ...
    var STRINGS = (_STRINGS3 = {}, (0, _defineProperty3.default)(_STRINGS3, workerState.online, '在线'), (0, _defineProperty3.default)(_STRINGS3, workerState.offline, '离线'), _STRINGS3);
