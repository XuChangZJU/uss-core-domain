...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, _defineProperty(_S, state.preparing, '准备中'), _defineProperty(_S, state.ready, '已就绪'), _defineProperty(_S, state.ongoing, '进行中'), _defineProperty(_S, state.finished, '已结束'), _S);
