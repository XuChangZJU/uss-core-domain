...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, _defineProperty(_STATE_TRAN_MATRIX, action.cancel, [state.bidding, state.cancelledBidding]), _defineProperty(_STATE_TRAN_MATRIX, action.cancelBidding, [state.bidding, state.cancelledBidding]), _defineProperty(_STATE_TRAN_MATRIX, action.cancelSuccess, [state.success, state.cancelledSuccess]), _defineProperty(_STATE_TRAN_MATRIX, action.success, [state.bidding, state.success]), _STATE_TRAN_MATRIX);
