...
var decodeAction = function decodeAction(a) {
    ...
    var S = (_S = {}, _defineProperty(_S, action.cancel, '撤销'), _defineProperty(_S, action.success, '成交'), _S);
...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, _defineProperty(_STATE_TRAN_MATRIX, action.cancel, [state.bidding, state.cancelled]), _defineProperty(_STATE_TRAN_MATRIX, action.success, [state.bidding, state.success]), _STATE_TRAN_MATRIX);
