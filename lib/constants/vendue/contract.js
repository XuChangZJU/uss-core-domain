...
var decodeState = function decodeState(s) {
    ...
    var DICT = (_DICT = {}, (0, _defineProperty3.default)(_DICT, state.contracted, '生效中'), (0, _defineProperty3.default)(_DICT, state.convertible, '可结算'), (0, _defineProperty3.default)(_DICT, state.completed, '结算完成'), (0, _defineProperty3.default)(_DICT, state.cancelled, '已取消'), (0, _defineProperty3.default)(_DICT, state.aborted, '已中止'), (0, _defineProperty3.default)(_DICT, state.buyerRefund, '买家已退款'), (0, _defineProperty3.default)(_DICT, state.contractRefunded, '委托方已退款'), _DICT);
