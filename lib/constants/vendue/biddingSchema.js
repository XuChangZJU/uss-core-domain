...
var STRINGS_OF_ORIGINS = (_STRINGS_OF_ORIGINS = {}, _defineProperty(_STRINGS_OF_ORIGINS, type.sequentiallyIncreasing, "顺序递增"), _defineProperty(_STRINGS_OF_ORIGINS, type.increasingBy258, "2/5/8递增"), _STRINGS_OF_ORIGINS);
...
function getChangedPrice(params) {
    ...
    if (!section) {
        if (price >= biddingSchema[biddingSchema.length - 1].max) {
            ...
            return FN[section.type](Object.assign({}, params, { section: section }));
        }
