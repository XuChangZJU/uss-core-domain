...
var STRINGS_OF_ORIGINS = (_STRINGS_OF_ORIGINS = {}, (0, _defineProperty3.default)(_STRINGS_OF_ORIGINS, type.sequentiallyIncreasing, "顺序递增"), (0, _defineProperty3.default)(_STRINGS_OF_ORIGINS, type.increasingBy258, "2/5/8递增"), _STRINGS_OF_ORIGINS);
...
function getChangedPrice(params) {
    ...
    var FN = (_FN = {}, (0, _defineProperty3.default)(_FN, type.increasingBy258, function (_ref) {
    ...
    }), (0, _defineProperty3.default)(_FN, type.sequentiallyIncreasing, function (_ref2) {
    ...
    if (!section) {
        if (price >= biddingSchema[biddingSchema.length - 1].max) {
            ...
            return FN[section.type]((0, _assign2.default)({}, params, { section: section }));
        }
    ...
    var ans = fn((0, _assign2.default)({}, params, { section: section }));
    if (ans > section.max) {
        return section.max;
    }
    if (ans < section.min) {
