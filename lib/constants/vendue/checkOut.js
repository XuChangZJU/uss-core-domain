...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var DICT = (_DICT2 = {}, (0, _defineProperty3.default)(_DICT2, transportState.shipping, '暂存中'), (0, _defineProperty3.default)(_DICT2, transportState.unpicked, '待提货'), (0, _defineProperty3.default)(_DICT2, transportAction.picked, '已提货'), _DICT2);
    return DICT[ts] || decodeCommonTransportState(ts);
};

var STATE_TRAN_MATRIX = (0, _assign2.default)((_Object$assign2 = {}, (0, _defineProperty3.default)(_Object$assign2, transportAction.taPrepare, [transportState.shipping, transportState.tsInPreparing]), (0, _defineProperty3.default)(_Object$assign2, transportAction.taCancel, [transportState.tsInPreparing, transportState.shipping]), (0, _defineProperty3.default)(_Object$assign2, action.takeAway, [transportState.unpicked, transportState.picked]), _Object$assign2), COMMON_STATE_TRAN_MATRIX, TRANSPORT_STATE_TRANS_MATRIX);
