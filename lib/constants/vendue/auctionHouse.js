...
=======
    auctioneer: 103,
    stockKeeper: 104
>>>>>>> 4c11f03710fc1910d02d45411110eb2f10e8d780
});
...
<<<<<<< HEAD
    var R = (_R = {}, _defineProperty(_R, relation.guardian, '守护者'), _defineProperty(_R, relation.worker, '员工'), _defineProperty(_R, relation.administrator, '管理员'), _defineProperty(_R, relation.stockManage, '库存管理员'), _R);
=======
    var R = (_R = {}, _defineProperty(_R, relation.guardian, '守护者'), _defineProperty(_R, relation.worker, '员工'), _defineProperty(_R, relation.auctioneer, '拍卖师'), _defineProperty(_R, relation.stockKeeper, '库管员'), _R);
>>>>>>> 4c11f03710fc1910d02d45411110eb2f10e8d780
