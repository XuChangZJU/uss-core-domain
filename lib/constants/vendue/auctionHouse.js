...
var decodeRelation = function decodeRelation(r) {
    ...
    var R = (_R = {}, _defineProperty(_R, relation.worker, '员工'), _defineProperty(_R, relation.auctioneer, '拍卖师'), _defineProperty(_R, relation.stockKeeper, '库管员'), _defineProperty(_R, relation.settler, '结算员'), _R);
