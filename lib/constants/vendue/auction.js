...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.ready, [state.preparing, state.ready]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.start, [[state.ready, state.unsold, state.pausing, state.sold], state.ongoing]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.sold, [state.ongoing, state.sold]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.unsold, [[state.ongoing, state.sold], state.unsold]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.pause, [state.ongoing, state.pausing]), _STATE_TRAN_MATRIX);
