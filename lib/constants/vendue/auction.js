...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, _defineProperty(_S, state.preparing, '准备中'), _defineProperty(_S, state.ready, '就绪'), _defineProperty(_S, state.ongoing, '拍卖中'), _defineProperty(_S, state.sold, '成交'), _defineProperty(_S, state.unsold, '流拍'), _defineProperty(_S, state.pausing, '暂停'), _defineProperty(_S, state.cancelled, '撤销'), _S);
