...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, (0, _defineProperty3.default)(_S, state.ready, '预展中'), (0, _defineProperty3.default)(_S, state.ongoing, '拍卖中'), (0, _defineProperty3.default)(_S, state.sold, '已成交'), (0, _defineProperty3.default)(_S, state.unsold, '已流拍'), (0, _defineProperty3.default)(_S, state.breakUp, '违约'), (0, _defineProperty3.default)(_S, state.pausing, '暂停'), (0, _defineProperty3.default)(_S, state.revoke, '撤销'), _S);
...
var decodeAction = function decodeAction(a) {
    ...
    var S = (_S2 = {}, (0, _defineProperty3.default)(_S2, action.ready, '就绪'), (0, _defineProperty3.default)(_S2, action.makeReady, '重新就绪'), (0, _defineProperty3.default)(_S2, action.start, '开拍'), (0, _defineProperty3.default)(_S2, action.restart, '重拍'), (0, _defineProperty3.default)(_S2, action.sold, '成交'), (0, _defineProperty3.default)(_S2, action.unsold, '流拍'), (0, _defineProperty3.default)(_S2, action.pause, '暂停'), (0, _defineProperty3.default)(_S2, action.breakUp, '违约'), _S2);
