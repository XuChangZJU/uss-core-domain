...
var decodeAction = function decodeAction(a) {
    ...
    var S = (_S2 = {}, (0, _defineProperty3.default)(_S2, action.ready, '就绪'), (0, _defineProperty3.default)(_S2, action.start, '开拍'), (0, _defineProperty3.default)(_S2, action.restart, '重拍'), (0, _defineProperty3.default)(_S2, action.sold, '成交'), (0, _defineProperty3.default)(_S2, action.unsold, '流拍'), (0, _defineProperty3.default)(_S2, action.pause, '暂停'), _S2);
...
var STATE_TRAN_MATRIX = (_STATE_TRAN_MATRIX = {}, (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.ready, [state.preparing, state.ready]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.start, [[state.ready, state.pausing], state.ongoing]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.sold, [state.ongoing, state.sold]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.unsold, [[state.ongoing, state.sold], state.unsold]), (0, _defineProperty3.default)(_STATE_TRAN_MATRIX, action.pause, [state.ongoing, state.pausing]), _STATE_TRAN_MATRIX);
