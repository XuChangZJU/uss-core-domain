...
var decodeState = function decodeState(s) {
    ...
    var S = (_S = {}, (0, _defineProperty3.default)(_S, state.ready, '预展中'), (0, _defineProperty3.default)(_S, state.ongoing, '拍卖中'), (0, _defineProperty3.default)(_S, state.sold, '已成交'), (0, _defineProperty3.default)(_S, state.unsold, '已流拍'), (0, _defineProperty3.default)(_S, state.breakUp, '违约'), (0, _defineProperty3.default)(_S, state.pausing, '暂停'), _S);
