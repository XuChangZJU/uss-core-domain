...
var decodeCategory = function decodeCategory(c) {
    ...
    var STRING_OF_CATEGORY = (_STRING_OF_CATEGORY = {}, _defineProperty(_STRING_OF_CATEGORY, category.normal, '正常'), _defineProperty(_STRING_OF_CATEGORY, category.creditable, '租借用'), _defineProperty(_STRING_OF_CATEGORY, category.lox, 'LoX用'), _STRING_OF_CATEGORY);
...
var decodeResult = function decodeResult(r) {
    ...
    var STRING_OF_RESULT = (_STRING_OF_RESULT = {}, _defineProperty(_STRING_OF_RESULT, result.success, '已成功'), _defineProperty(_STRING_OF_RESULT, result.keyWordValidateFail, '验证密码失败'), _defineProperty(_STRING_OF_RESULT, result.flashReadingError, '读flash失败'), _defineProperty(_STRING_OF_RESULT, result.flashWritingError, '写flash失败'), _defineProperty(_STRING_OF_RESULT, result.actionDisallowed, '操作被拒绝'), _defineProperty(_STRING_OF_RESULT, result.commandUnrecognized, '不能识别的命令'), _defineProperty(_STRING_OF_RESULT, result.paramLengthIllegal, '参数不合法'), _defineProperty(_STRING_OF_RESULT, result.dataInconsistency, '数据不一致'), _defineProperty(_STRING_OF_RESULT, result.notEnoughMemory, '内存不足'), _STRING_OF_RESULT);
...
var decodeAction = function decodeAction(a) {
    ...
    var STRING = (_STRING = {}, _defineProperty(_STRING, action.unlock, '开门'), _defineProperty(_STRING, action.confirm, '确认'), _defineProperty(_STRING, action.dfu, 'DFU'), _defineProperty(_STRING, action.getKeyWord, '获取钥匙原语'), _defineProperty(_STRING, action.confirmOutdate, '确认过期'), _defineProperty(_STRING, action.clearBonds, '清除bonds'), _defineProperty(_STRING, action.resetConstantKeyWord, '重置持久性钥匙原语'), _defineProperty(_STRING, action.syncTime, '同步时间'), _defineProperty(_STRING, action.create, '创建'), _defineProperty(_STRING, action.drop, '删除'), _defineProperty(_STRING, action.dfuSuccess, 'DFU成功'), _defineProperty(_STRING, action.dfuFailure, 'DFU失败'), _STRING);
    return STRING[a];
};
