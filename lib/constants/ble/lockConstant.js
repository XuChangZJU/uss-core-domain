...
var decodeAction = function decodeAction(a) {
    ...
    var STRING = (_STRING = {}, _defineProperty(_STRING, action.unlock, '开门'), _defineProperty(_STRING, action.confirm, '确认'), _defineProperty(_STRING, action.dfu, 'DFU'), _defineProperty(_STRING, action.getKeyWord, '获取钥匙原语'), _defineProperty(_STRING, action.confirmOutdate, '确认过期'), _defineProperty(_STRING, action.clearBonds, '清除bonds'), _defineProperty(_STRING, action.resetConstantKeyWord, '重置持久性钥匙原语'), _defineProperty(_STRING, action.syncTime, '同步时间'), _STRING);
};
