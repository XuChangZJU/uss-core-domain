...
var STATE_TRANS_MATRIX = pick(TRANSPORT_STATE_TRANS_MATRIX, Object.values(action));
...
var decodeOrigin = function decodeOrigin(o) {
    ...
    var TEXT = (_TEXT = {}, _defineProperty(_TEXT, origin.weChatV3Partner, '微信收付通'), _defineProperty(_TEXT, origin.lianlian, '连连'), _defineProperty(_TEXT, origin.shouQianBa, '收钱吧'), _TEXT);
