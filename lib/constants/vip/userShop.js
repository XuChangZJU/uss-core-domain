...
var decodeAction = function decodeAction(a) {
    ...
    var STRINGS = (_STRINGS = {}, _defineProperty(_STRINGS, action.addPartner, '增加合伙人'), _defineProperty(_STRINGS, action.removePartner, '移除合伙人'), _defineProperty(_STRINGS, action.addManager, '增加管理员'), _defineProperty(_STRINGS, action.removeManager, '移除管理员'), _STRINGS);
