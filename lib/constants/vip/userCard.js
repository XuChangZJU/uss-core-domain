...
var decodeGrantRelationAction = function decodeGrantRelationAction(r, grant) {
    var STRING_GRANT = _defineProperty({}, relation.grantee, '分享会员卡');
<<<<<<< HEAD
    var STRING_CONFIRM = _defineProperty({}, relation.owner, '分享给您一张会员卡');
=======
    var STRING_CONFIRM = _defineProperty({}, relation.grantee, '分享给您一张会员卡');
>>>>>>> b9b8e2b0192f078e0dd6b08dbe4f2c79a383d821
