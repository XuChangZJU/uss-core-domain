...
var decodeResult = function decodeResult(r) {
    ...
    var S = (_S2 = {}, _defineProperty(_S2, result.success, '成功'), _defineProperty(_S2, result.suspicious, '可疑'), _defineProperty(_S2, result.rejected, '被拒'), _defineProperty(_S2, result.uncertain, '验证中'), _S2);
