...
var decodeResult = function decodeResult(r) {
    ...
    var S = (_S2 = {}, _defineProperty(_S2, result.success, '成功的'), _defineProperty(_S2, result.suspicious, '可疑的'), _defineProperty(_S2, result.rejected, '拒绝的'), _defineProperty(_S2, result.uncertain, '待检查的'), _S2);
