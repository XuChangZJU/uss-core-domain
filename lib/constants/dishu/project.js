...
var decodeAction = function decodeAction(a) {
    ...
    var S = (_S3 = {}, _defineProperty(_S3, action.makeDead, '使结束'), _defineProperty(_S3, action.createAttendance, '创建签到簿'), _defineProperty(_S3, action.updateAttendance, '修改签到簿'), _defineProperty(_S3, action.appendAttendanceWifiList, '为签到簿'), _S3);
