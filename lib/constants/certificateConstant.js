...
var decoder = (_decoder = {}, _defineProperty(_decoder, cardStatus.empty, "未验证"), _defineProperty(_decoder, cardStatus.verifying1, "验证身份信息中"), _defineProperty(_decoder, cardStatus.verifying2, "验证身份图像信息中"), _defineProperty(_decoder, cardStatus.verifying3, "验证身份信息中（图像已上传）"), _defineProperty(_decoder, cardStatus.uncertain1, "姓名证件号码未确定"), _defineProperty(_decoder, cardStatus.uncertain2, "身份证图像识别未确定"), _defineProperty(_decoder, cardStatus.uncertain3, "证件号码与图像均未确定"), _defineProperty(_decoder, cardStatus.illegal, "实名认证未获通过"), _defineProperty(_decoder, cardStatus.illegal2, "实名认证未获通过（图像已上传）"), _defineProperty(_decoder, cardStatus.illegal3, "该实名信息已被使用"), _defineProperty(_decoder, cardStatus.imageAcceptable, "实名认证已通过（图像未上传）"), _defineProperty(_decoder, cardStatus.imageReceived, "身份证图像已上传"), _defineProperty(_decoder, cardStatus.imageIllegal, "身份证图像验证失败"), _defineProperty(_decoder, cardStatus.legal, "实名认证已通过"), _decoder);
