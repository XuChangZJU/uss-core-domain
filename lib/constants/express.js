        ...
        "#data": [{
            check: function check(_ref) {
                ...
                if (![transportState.tsInPreparing].includes(row.transportState)) {
                    return ErrorCode.createErrorByCode(ErrorCode.errorDataInconsistency, '\u5F53\u524D\u7269\u6D41\u72B6\u6001\u4E0D\u652F\u6301' + decodeTransportAction(action.taSend) + '\u64CD\u4F5C', {
                        name: 'express',
                        operation: 'update',
                        data: row
                    });
        ...
        "#data": [{
            check: function check(_ref2) {
                ...
                if (![transportState.tsSending].includes(row.transportState)) {
                    return ErrorCode.createErrorByCode(ErrorCode.errorDataInconsistency, '\u5F53\u524D\u7269\u6D41\u72B6\u6001\u4E0D\u652F\u6301' + decodeTransportAction(action.taAccept) + '\u64CD\u4F5C', {
                        name: 'express',
                        operation: 'update',
                        data: row
                    });
    ...
    auths: [{
        "#data": [{
            check: function check(_ref3) {
                ...
                if (![transportState.tsSending].includes(row.transportState)) {
                    return ErrorCode.createErrorByCode(ErrorCode.errorDataInconsistency, '\u5F53\u524D\u7269\u6D41\u72B6\u6001\u4E0D\u652F\u6301' + decodeTransportAction(action.taReject) + '\u64CD\u4F5C', {
                        name: 'express',
                        operation: 'update',
                        data: row
                    });
