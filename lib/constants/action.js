...
var decodeAction = function decodeAction(a) {
    ...
    var STRINGS = (_STRINGS2 = {}, _defineProperty(_STRINGS2, action.create, '创建'), _defineProperty(_STRINGS2, action.update, '更新数据'), _defineProperty(_STRINGS2, action.remove, '删除'), _defineProperty(_STRINGS2, action.grant, '授予'), _defineProperty(_STRINGS2, action.revoke, '回收'), _defineProperty(_STRINGS2, action.abandon, '放弃'), _defineProperty(_STRINGS2, action.confirmToPay, '确认下单'), _defineProperty(_STRINGS2, action.pay, '支付成功'), _defineProperty(_STRINGS2, action.cancel, '取消支付'), _defineProperty(_STRINGS2, action.abort, '中止'), _defineProperty(_STRINGS2, action.expire, '过期'), _defineProperty(_STRINGS2, action.makePaid, '自动支付'), _STRINGS2);
