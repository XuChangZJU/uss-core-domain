...
var action = (_action = {
    ...
    refundCancel: 55 }, _defineProperty(_action, 'getList', 60), _defineProperty(_action, 'getItem', 61), _defineProperty(_action, 'count', 62), _defineProperty(_action, 'stat', 63), _defineProperty(_action, 'download', 64), _action);
...
var decodeTransportState = function decodeTransportState(ts) {
    ...
    var TEXT = (_TEXT = {}, _defineProperty(_TEXT, transportState.inPreparing, '备货中'), _defineProperty(_TEXT, transportState.sending, '发货中'), _defineProperty(_TEXT, transportState.accepted, '已收货'), _defineProperty(_TEXT, transportState.rejected, '已拒收'), _defineProperty(_TEXT, transportState.abnormal, '异常中止'), _TEXT);
...
var decodeTransportAction = function decodeTransportAction(ta) {
    ...
    var TEXT = (_TEXT2 = {}, _defineProperty(_TEXT2, transportAction.send, '发货'), _defineProperty(_TEXT2, transportAction.accept, '接收'), _defineProperty(_TEXT2, transportAction.reject, '拒绝'), _defineProperty(_TEXT2, transportAction.abort, '中止'), _TEXT2);

    return TEXT[ta];
};

var TRANSPORT_STATE_TRANS_MATRIX = (_TRANSPORT_STATE_TRAN = {}, _defineProperty(_TRANSPORT_STATE_TRAN, transportAction.send, [transportState.inPreparing, transportState.sending]), _defineProperty(_TRANSPORT_STATE_TRAN, transportAction.accept, [transportState.sending, transportState.accepted]), _defineProperty(_TRANSPORT_STATE_TRAN, transportAction.reject, [transportState.sending, transportState.rejected]), _defineProperty(_TRANSPORT_STATE_TRAN, transportAction.abort, [[transportState.inPreparing, transportState.sending, transportState.accepted, transportState.rejected], transportState.abnormal]), _TRANSPORT_STATE_TRAN);
