...
var decodeAction = function decodeAction(a) {
    ...
    var STRINGS = (_STRINGS2 = {}, _defineProperty(_STRINGS2, action.create, '创建'), _defineProperty(_STRINGS2, action.update, '更新'), _defineProperty(_STRINGS2, action.remove, '删除'), _defineProperty(_STRINGS2, action.createSub, '创建子结点'), _defineProperty(_STRINGS2, action.authGrant, '授权'), _defineProperty(_STRINGS2, action.authRevoke, '回收'), _defineProperty(_STRINGS2, action.authAbandon, '放弃'), _defineProperty(_STRINGS2, action.authConfirm, '确认'), _defineProperty(_STRINGS2, action.authGrantMulti, '散发'), _defineProperty(_STRINGS2, action.transfer, '转让'), _defineProperty(_STRINGS2, action.acquire, '申请'), _defineProperty(_STRINGS2, action.confirmToPay, '确认下单'), _defineProperty(_STRINGS2, action.pay, '支付成功'), _defineProperty(_STRINGS2, action.cancel, '取消'), _defineProperty(_STRINGS2, action.abort, '中止'), _defineProperty(_STRINGS2, action.expire, '过期'), _defineProperty(_STRINGS2, action.makePaid, '自动支付'), _defineProperty(_STRINGS2, action.complete, '完成'), _defineProperty(_STRINGS2, action.abandon, '取消'), _defineProperty(_STRINGS2, action.abort2, '异步中止'), _defineProperty(_STRINGS2, action.abort2Success, '异步中止成功'), _defineProperty(_STRINGS2, action.abandon2, '异步取消'), _defineProperty(_STRINGS2, action.abandon2Success, '异步取消成功'), _defineProperty(_STRINGS2, action.send, '发货'), _defineProperty(_STRINGS2, action.reject, '拒收'), _defineProperty(_STRINGS2, action.apply, '申请'), _defineProperty(_STRINGS2, action.agree, '同意'), _STRINGS2);
