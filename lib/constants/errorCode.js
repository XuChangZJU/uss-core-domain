...
module.exports = {
	...
	userDisabled: { code: 894, message: '您的帐户已被禁用，请联系我们' },
	userDangerous: { code: 893, message: '您的帐户被判为危险用户，请联系我们' },
	userHasToLoginByPassword: { code: 892, message: '已有相同手机号的合法帐户，不允许使用验证码设置此手机号为您的手机号，如果您是该帐户主人，请使用密码进行设置' },
	...
	errorNeedCharge: { code: 802, message: '需要充值' },
