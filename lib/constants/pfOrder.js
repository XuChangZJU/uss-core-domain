...
var _require3 = require('../constants/roleConstant2'),
    Roles = _require3.Roles;

var state = pick(commonState, ['unpaid', 'legal', 'paying', 'partialPaid', 'refunding', 'refunded', 'partialRefunded', 'expired', 'completed']);

var action = pick(commonAction, ['stopPaying', 'pay', 'expire', 'complete', 'payPartially', 'startToPay', 'refund', 'refundSuccess', 'refundPartially']);
...
}), (0, _defineProperty3.default)(_AUTH_MATRIX, action.stopPaying, {
    auths: [{
        "#role": [Roles.ROOT.name]
    }]
